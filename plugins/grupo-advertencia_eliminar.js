...
if (!db.data.chats[m.chat].antitoxic && m.isGroup) return conn.sendButton(m.chat, wm, lenguajeMY.smsAdveu1() + lenGB, null, [[lenguajeMY.smsEncender(), lenGB]], fkontak, m) 
...
if (!who) return conn.reply(m.chat, lenguajeMY.smsMalused3() + `*${usedPrefix + command} @${name}*`, fkontak, m)  
try{
user.warn -= 1
 
   await m.reply(`${user.warn == 1 ? `*@${who.split`@`[0]}*` : `♻️ *@${who.split`@`[0]}*`}  ${lenguajeMY['smsAdveu10']()}\n\n*${lenguajeMY['smsAdveu5']()}*\n⚠️ *${lenguajeMY['smsAdveu11']()} ${user.warn + 1}/4*\n⚠️ *${lenguajeMY['smsAdveu12']()} ${user.warn}/4*`, null, { mentions: [who]})
/*await conn.sendButton(m.chat,`${user.warn == 1 ? `*@${who.split`@`[0]}*` : `♻️ *@${who.split`@`[0]}*`} ${lenguajeMY['smsAdveu10']()}`, `*${lenguajeMY['smsAdveu5']()}*\n⚠️ *${lenguajeMY['smsAdveu11']()} ${user.warn + 1}/4*\n⚠️ *${lenguajeMY['smsAdveu12']()} ${user.warn}/4*\n\n${wm}`, img, [
[lenguajeMY.smsAdveu9(), '.ok'],
