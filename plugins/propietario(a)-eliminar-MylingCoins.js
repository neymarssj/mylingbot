...
money -= pjk
if (money < 1) throw `${mg}𝙀𝙇 𝙉𝙐𝙈𝙀𝙍𝙊 𝙈𝙄𝙉𝙄𝙈𝙊 𝘿𝙀 𝗠𝘆𝗹𝗶𝗻𝗴𝗖𝗼𝗶𝗻𝘀 𝙀𝙎 *1*\n\n𝙏𝙃𝙀 𝙈𝙄𝙉𝙄𝙈𝙐𝙈 𝙉𝙐𝙈𝘽𝙀𝙍 𝙁𝙍𝙊𝙈 𝗠𝘆𝗹𝗶𝗻𝗴𝗖𝗼𝗶𝗻𝘀 𝙄𝙎 *1*`
let users = global.db.data.users
users[who].money -= gatacoins
m.reply(`╭━━━[ 𝗠𝘆𝗹𝗶𝗻𝗴𝗖𝗼𝗶𝗻𝘀 👻 ]━━━⬣\n┃\n┃ღ *PARA | FOR:*\n┃ღ *${text}*\n┃┈┈┈┈┈┈┈┈┈┈┈┈┈┈┈┈┈\n┃ღ *SE ELIMINÓ | WAS REMOVED*\n┃ღ *${mylingcoins} MylingCoin(s)* 👻\n┃\n╰━━━━━━━━━━━━━━⬣`)}
/*conn.sendHydrated(m.chat, `╭━━━[ 𝗠𝘆𝗹𝗶𝗻𝗴𝗖𝗼𝗶𝗻𝘀 👻 ]━━━⬣\n┃\n┃ღ *PARA | FOR:*\n┃ღ *${text}*\n┃┈┈┈┈┈┈┈┈┈┈┈┈┈┈┈┈┈\n┃ღ *SE ELIMINÓ | WAS REMOVED*\n┃ღ *${mylingcoins} MylingCoins(s)* 👻\n┃\n╰━━━━━━━━━━━━━━⬣`, wm, null, md, '𝗠𝘆𝗹𝗶𝗻𝗴𝗕𝗼𝘁-𝗠𝗗', null, null, [
['💗 𝙈𝙚𝙣𝙪 𝘼𝙫𝙚𝙣𝙩𝙪𝙧𝙖 | 𝙍𝙋𝙂 💗', '.rpgmenu'],
['𝙑𝙤𝙡𝙫𝙚𝙧 𝙖𝙡 𝙈𝙚𝙣𝙪́ | 𝘽𝙖𝙘𝙠 𝙩𝙤 𝙈𝙚𝙣𝙪 ☘️', '/menu']], m)
}*/
handler.help = ['addgb <@user>']
handler.tags = ['MylingCoins']
handler.command = ['eliminarcoins','quitarcoins','delcoins', 'deletecoins'] 
handler.group = true
handler.rowner = true
