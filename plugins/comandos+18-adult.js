...
let frep = { contextInfo: { externalAdReply: {title: wm, body: lenguajeMY.smsCont18Porn2(), sourceUrl: redesMenu.getRandom(), thumbnail: await(await fetch(img16)).buffer() }}}
...
//await conn.sendButton(m.chat, lenguajeMY.smsCont18Porn(), ` *_${lenguajeMY['smsBotonM7']()}_* » ${user.premiumTime > 0 ? '✅' : '❌'}\n` + wm + ` : *${command[0].toUpperCase() + command.substring(1)}*`, enlace, [[lenguajeMY.smsSig(), `${usedPrefix + command}`], [lenguajeMY.lenguaje() == 'es' ? '🔞 ver lista porno 🔞'.toUpperCase() : '🔞 list horny🔞 '.toUpperCase(), lenguajeMY.lenguaje() == 'es' ? usedPrefix + 'listaporno' : usedPrefix + 'listhorny']], m, frep)}
...
let enlace = await res[Math.floor(res.length * Math.random())]  
await conn.sendFile(m.chat, enlace, null, `${lenguajeMY['smsCont18Porn']()}\n${lenguajeMY['smsBotonM7']()} » ${user.premiumTime > 0 ? '✅' : '❌'}`, null, null, {viewOnce: false}, m)}
//await conn.sendButton(m.chat, lenguajeMY.smsCont18Porn(), ` *_${lenguajeMY['smsBotonM7']()}_* » ${user.premiumTime > 0 ? '✅' : '❌'}\n` + wm + ` : *${command[0].toUpperCase() + command.substring(1)}*`, enlace, [[lenguajeMY.smsSig(), `${usedPrefix + command}`], [`🥵 ${lenguajeMY.lenguaje() == 'es' ? 'porno pies 2' : 'nsfw foot 2'} 🥵`.toUpperCase(), `${usedPrefix}${lenguajeMY.lenguaje() == 'es' ? 'pornopies2' : 'nsfwfoot2'}`]], m, frep)}
...
let enlace = await res[Math.floor(res.length * Math.random())]  
await conn.sendFile(m.chat, enlace, null, `${lenguajeMY['smsCont18Porn']()}\n${lenguajeMY['smsBotonM7']()} » ${user.premiumTime > 0 ? '✅' : '❌'}`, null, null, {viewOnce: false}, m)}
//await conn.sendButton(m.chat, lenguajeMY.smsCont18Porn(), ` *_${lenguajeMY['smsBotonM7']()}_* » ${user.premiumTime > 0 ? '✅' : '❌'}\n` + wm + ` : *${command[0].toUpperCase() + command.substring(1)}*`, enlace, [[lenguajeMY.smsSig(), `${usedPrefix + command}`], [`🥵 ${lenguajeMY.lenguaje() == 'es' ? 'porno ass 2' : 'nsfw ass 2'} 🥵`.toUpperCase(), `${usedPrefix}${lenguajeMY.lenguaje() == 'es' ? 'pornoass2' : 'nsfwass2'}`]], m, frep)}
...
let enlace = await res[Math.floor(res.length * Math.random())]  
await conn.sendFile(m.chat, enlace, null, `${lenguajeMY['smsCont18Porn']()}\n${lenguajeMY['smsBotonM7']()} » ${user.premiumTime > 0 ? '✅' : '❌'}`, null, null, {viewOnce: false}, m)}
//await conn.sendButton(m.chat, lenguajeMY.smsCont18Porn(), ` *_${lenguajeMY['smsBotonM7']()}_* » ${user.premiumTime > 0 ? '✅' : '❌'}\n` + wm + ` : *${command[0].toUpperCase() + command.substring(1)}*`, enlace, [[lenguajeMY.smsSig(), `${usedPrefix + command}`], [`🥵 ${lenguajeMY.lenguaje() == 'es' ? 'porno fuck' : 'nsfw fuck'} 🥵`.toUpperCase(), `${usedPrefix}${lenguajeMY.lenguaje() == 'es' ? 'pornofuck' : 'nsfwfuck'}`]], m, frep)}
...
let enlace = await res[Math.floor(res.length * Math.random())]  
await conn.sendFile(m.chat, enlace, null, `${lenguajeMY['smsCont18Porn']()}\n${lenguajeMY['smsBotonM7']()} » ${user.premiumTime > 0 ? '✅' : '❌'}`, null, null, {viewOnce: false}, m)}
//await conn.sendButton(m.chat, lenguajeMY.smsCont18Porn(), ` *_${lenguajeMY['smsBotonM7']()}_* » ${user.premiumTime > 0 ? '✅' : '❌'}\n` + wm + ` : *${command[0].toUpperCase() + command.substring(1)}*`, enlace, [[lenguajeMY.smsSig(), `${usedPrefix + command}`], [`🥵 ${lenguajeMY.lenguaje() == 'es' ? 'porno cum 2' : 'nsfw cum 2'} 🥵`.toUpperCase(), `${usedPrefix}${lenguajeMY.lenguaje() == 'es' ? 'pornocum' : 'nsfwcum'}`]], m, frep)}
...
let enlace = await res[Math.floor(res.length * Math.random())]  
await conn.sendFile(m.chat, enlace, null, `${lenguajeMY['smsCont18Porn']()}\n${lenguajeMY['smsBotonM7']()} » ${user.premiumTime > 0 ? '✅' : '❌'}`, null, null, {viewOnce: false}, m)}
//await conn.sendButton(m.chat, lenguajeMY.smsCont18Porn(), ` *_${lenguajeMY['smsBotonM7']()}_* » ${user.premiumTime > 0 ? '✅' : '❌'}\n` + wm + ` : *${command[0].toUpperCase() + command.substring(1)}*`, enlace, [[lenguajeMY.smsSig(), `${usedPrefix + command}`], [`🥵 ${lenguajeMY.lenguaje() == 'es' ? 'porno hero academy' : 'nsfw hero academy'} 🥵`.toUpperCase(), `${usedPrefix}${lenguajeMY.lenguaje() == 'es' ? 'pornoheroacademy' : 'nsfwheroacademy'}`]], m, frep)}
...
let enlace = await res[Math.floor(res.length * Math.random())]  
await conn.sendFile(m.chat, enlace, null, `${lenguajeMY['smsCont18Porn']()}\n${lenguajeMY['smsBotonM7']()} » ${user.premiumTime > 0 ? '✅' : '❌'}`, null, null, {viewOnce: false}, m)}
//await conn.sendButton(m.chat, lenguajeMY.smsCont18Porn(), ` *_${lenguajeMY['smsBotonM7']()}_* » ${user.premiumTime > 0 ? '✅' : '❌'}\n` + wm + ` : *${command[0].toUpperCase() + command.substring(1)}*`, enlace, [[lenguajeMY.smsSig(), `${usedPrefix + command}`], [`🥵 ${lenguajeMY.lenguaje() == 'es' ? 'porno ass 3' : 'nsfw ass 3'} 🥵`.toUpperCase(), `${usedPrefix}${lenguajeMY.lenguaje() == 'es' ? 'pornoass3' : 'nsfwass3'}`]], m, frep)}
...
let enlace = await res[Math.floor(res.length * Math.random())]  
await conn.sendFile(m.chat, enlace, null, `${lenguajeMY['smsCont18Porn']()}\n${lenguajeMY['smsBotonM7']()} » ${user.premiumTime > 0 ? '✅' : '❌'}`, null, null, {viewOnce: false}, m)}
//await conn.sendButton(m.chat, lenguajeMY.smsCont18Porn(), ` *_${lenguajeMY['smsBotonM7']()}_* » ${user.premiumTime > 0 ? '✅' : '❌'}\n` + wm + ` : *${command[0].toUpperCase() + command.substring(1)}*`, enlace, [[lenguajeMY.smsSig(), `${usedPrefix + command}`], [`🥵 ${lenguajeMY.lenguaje() == 'es' ? 'porno hentai 3' : 'nsfw hentai 3'} 🥵`.toUpperCase(), `${usedPrefix}${lenguajeMY.lenguaje() == 'es' ? 'pornohentai3' : 'nsfwhentai3'}`]], m, frep)}
...
let enlace = await res[Math.floor(res.length * Math.random())]
await conn.sendFile(m.chat, enlace, null, `${lenguajeMY['smsCont18Porn']()}\n${lenguajeMY['smsBotonM7']()} » ${user.premiumTime > 0 ? '✅' : '❌'}`, null, null, {viewOnce: false}, m)}
//await conn.sendButton(m.chat, lenguajeMY.smsCont18Porn(), ` *_${lenguajeMY['smsBotonM7']()}_* » ${user.premiumTime > 0 ? '✅' : '❌'}\n` + wm + ` : *${command[0].toUpperCase() + command.substring(1)}*`, enlace, [[lenguajeMY.smsSig(), `${usedPrefix + command}`], [`🥵 ${lenguajeMY.lenguaje() == 'es' ? 'porno orgia 2' : 'nsfw orgy 2'} 🥵`.toUpperCase(), `${usedPrefix}${lenguajeMY.lenguaje() == 'es' ? 'pornorgia2' : 'nsfworgy2'}`]], m, frep)}
...
await conn.sendFile(m.chat, res, null, `${lenguajeMY['smsCont18Porn']()}\n${lenguajeMY['smsBotonM7']()} » ${user.premiumTime > 0 ? '✅' : '❌'}`, null, null, {viewOnce: false}, m)}
//await conn.sendButton(m.chat, lenguajeMY.smsCont18Porn(), ` *_${lenguajeMY['smsBotonM7']()}_* » ${user.premiumTime > 0 ? '✅' : '❌'}\n` + wm + ` : *${command[0].toUpperCase() + command.substring(1)}*`, res, [[lenguajeMY.smsSig(), `${usedPrefix + command}`], [`🥵 ${lenguajeMY.lenguaje() == 'es' ? 'porno tetas 3' : 'nsfw boobs 3'} 🥵`.toUpperCase(), `${usedPrefix}${lenguajeMY.lenguaje() == 'es' ? 'pornotetas3' : 'nsfwboobs3'}`]], m, frep)}
...
if (res == '' || !res || res == null) res = await resError[Math.floor(resError.length * Math.random())]  
await conn.sendFile(m.chat, res, null, `${lenguajeMY['smsCont18Porn']()}\n${lenguajeMY['smsBotonM7']()} » ${user.premiumTime > 0 ? '✅' : '❌'}`, null, null, {viewOnce: false}, m)}
//await conn.sendButton(m.chat, lenguajeMY.smsCont18Porn(), ` *_${lenguajeMY['smsBotonM7']()}_* » ${user.premiumTime > 0 ? '✅' : '❌'}\n` + wm + ` : *${command[0].toUpperCase() + command.substring(1)}*`, res, [[lenguajeMY.smsSig(), `${usedPrefix + command}`], [lenguajeMY.lenguaje() == 'es' ? '🔞 ver lista porno 🔞'.toUpperCase() : '🔞 list horny🔞 '.toUpperCase(), lenguajeMY.lenguaje() == 'es' ? usedPrefix + 'listaporno' : usedPrefix + 'listhorny']], m, frep)}
...
let enlace = await res[Math.floor(res.length * Math.random())]
await conn.sendFile(m.chat, enlace, null, `${lenguajeMY['smsCont18Porn']()}\n${lenguajeMY['smsBotonM7']()} » ${user.premiumTime > 0 ? '✅' : '❌'}`, null, null, {viewOnce: false}, m)}
//await conn.sendButton(m.chat, lenguajeMY.smsCont18Porn(), ` *_${lenguajeMY['smsBotonM7']()}_* » ${user.premiumTime > 0 ? '✅' : '❌'}\n` + wm + ` : *${command[0].toUpperCase() + command.substring(1)}*`, enlace, [[lenguajeMY.smsSig(), `${usedPrefix + command}`], [`🥵 ${lenguajeMY.lenguaje() == 'es' ? 'porno furro 2' : 'nsfw furry 2'} 🥵`.toUpperCase(), `${usedPrefix}${lenguajeMY.lenguaje() == 'es' ? 'pornofurro2' : 'nsfwfurry2'}`]], m, frep)}
...
if (res == '' || !res || res == null) res = await resError[Math.floor(resError.length * Math.random())]  
await conn.sendFile(m.chat, res, null, `${lenguajeMY['smsCont18Porn']()}\n${lenguajeMY['smsBotonM7']()} » ${user.premiumTime > 0 ? '✅' : '❌'}`, null, null, {viewOnce: false}, m)}
//await conn.sendButton(m.chat, lenguajeMY.smsCont18Porn(), ` *_${lenguajeMY['smsBotonM7']()}_* » ${user.premiumTime > 0 ? '✅' : '❌'}\n` + wm + ` : *${command[0].toUpperCase() + command.substring(1)}*`, res, [[lenguajeMY.smsSig(), `${usedPrefix + command}`], [`🥵 ${lenguajeMY.lenguaje() == 'es' ? 'porno chica' : 'nsfws girl'} 🥵`.toUpperCase(), `${usedPrefix}${lenguajeMY.lenguaje() == 'es' ? 'pornochica' : 'nsfwsgirl'}`]], m, frep)} 
...
let enlace = await res[Math.floor(res.length * Math.random())]
await conn.sendFile(m.chat, enlace, null, `${lenguajeMY['smsCont18Porn']()}\n${lenguajeMY['smsBotonM7']()} » ${user.premiumTime > 0 ? '✅' : '❌'}`, null, null, {viewOnce: false}, m)}
//await conn.sendButton(m.chat, lenguajeMY.smsCont18Porn(), ` *_${lenguajeMY['smsBotonM7']()}_* » ${user.premiumTime > 0 ? '✅' : '❌'}\n` + wm + ` : *${command[0].toUpperCase() + command.substring(1)}*`, enlace, [[lenguajeMY.smsSig(), `${usedPrefix + command}`], [`🥵 ${lenguajeMY.lenguaje() == 'es' ? 'porno chica 2' : 'nsfws girl 2'} 🥵`.toUpperCase(), `${usedPrefix}${lenguajeMY.lenguaje() == 'es' ? 'pornochica2' : 'nsfwsgirl2'}`]], m, frep)}
...
let enlace = await res[Math.floor(res.length * Math.random())]
await conn.sendFile(m.chat, res, null, `${lenguajeMY['smsCont18Porn']()}\n${lenguajeMY['smsBotonM7']()} » ${user.premiumTime > 0 ? '✅' : '❌'}`, null, null, {viewOnce: false}, m)}
//await conn.sendButton(m.chat, lenguajeMY.smsCont18Porn(), ` *_${lenguajeMY['smsBotonM7']()}_* » ${user.premiumTime > 0 ? '✅' : '❌'}\n` + wm + ` : *${command[0].toUpperCase() + command.substring(1)}*`, enlace, [[lenguajeMY.smsSig(), `${usedPrefix + command}`], [`🥵 ${lenguajeMY.lenguaje() == 'es' ? 'porno 4k' : 'nsfws 4k'} 🥵`.toUpperCase(), `${usedPrefix}${lenguajeMY.lenguaje() == 'es' ? 'porno4k' : 'porn4k'}`]], m, frep)}
...
let enlace = await res[Math.floor(res.length * Math.random())]
await conn.sendFile(m.chat, enlace, null, `${lenguajeMY['smsCont18Porn']()}\n${lenguajeMY['smsBotonM7']()} » ${user.premiumTime > 0 ? '✅' : '❌'}`, null, null, {viewOnce: false}, m)}
//await conn.sendButton(m.chat, lenguajeMY.smsCont18Porn(), ` *_${lenguajeMY['smsBotonM7']()}_* » ${user.premiumTime > 0 ? '✅' : '❌'}\n` + wm + ` : *${command[0].toUpperCase() + command.substring(1)}*`, enlace, [[lenguajeMY.smsSig(), `${usedPrefix + command}`], [`🥵 ${lenguajeMY.lenguaje() == 'es' ? 'porno muslo' : 'nsfw hthigh'} 🥵`.toUpperCase(), `${usedPrefix}${lenguajeMY.lenguaje() == 'es' ? 'pornomuslo' : 'nsfwhthigh'}`]], m, frep)}
...
//await conn.sendButton(m.chat, lenguajeMY.smsCont18Porn(), `*_${lenguajeMY['smsBotonM7']()}_* » ${user.premiumTime > 0 ? '✅' : '❌'}\n` + wm + ` : *${command[0].toUpperCase() + command.substring(1)}*`, null, [[lenguajeMY.smsSig(), `${usedPrefix + command}`], [`🥵 ${lenguajeMY.lenguaje() == 'es' ? 'porno yaoi 2' : 'nsfw yaoi 2'} 🥵`.toUpperCase(), `${usedPrefix}${lenguajeMY.lenguaje() == 'es' ? 'pornoyaoi2' : 'nsfwyaoi2'}`]], fkontak, m)
}else{
await conn.sendFile(m.chat, link, null, `${lenguajeMY['smsCont18Porn']()}\n${lenguajeMY['smsBotonM7']()} » ${user.premiumTime > 0 ? '✅' : '❌'}`, null, null, {viewOnce: false}, m)}}
//await conn.sendButton(m.chat, lenguajeMY.smsCont18Porn(), `*_${lenguajeMY['smsBotonM7']()}_* » ${user.premiumTime > 0 ? '✅' : '❌'}\n` + wm + ` : *${command[0].toUpperCase() + command.substring(1)}*`, link, [[lenguajeMY.smsSig(), `${usedPrefix + command}`], [`🥵 ${lenguajeMY.lenguaje() == 'es' ? 'porno yaoi 2' : 'nsfw yaoi 2'} 🥵`.toUpperCase(), `${usedPrefix}${lenguajeMY.lenguaje() == 'es' ? 'pornoyaoi2' : 'nsfwyaoi2'}`]], m, frep)}}
...
await conn.sendFile(m.chat, stickerr, 'sticker.webp', '', m, true, { contextInfo: { 'forwardingScore': 200, 'isForwarded': false, externalAdReply:{ showAdAttribution: false, title: lenguajeMY.smsCont18PornP2(), body: wm, mediaType: 2, sourceUrl: redesMenu.getRandom(), thumbnail: await(await fetch(img16)).buffer()}}}, { quoted: m })
await conn.sendFile(m.chat, null, null, `${lenguajeMY['smsCont18Porn']()}\n${lenguajeMY['smsBotonM7']()} » ${user.premiumTime > 0 ? '✅' : '❌'}`, null, null, {viewOnce: false}, m)}}
//await conn.sendButton(m.chat, lenguajeMY.smsCont18PornP(), `*_${lenguajeMY['smsBotonM7']()}_* » ${user.premiumTime > 0 ? '✅' : '❌'}\n` + wm + ` : *${command[0].toUpperCase() + command.substring(1)}*`, null, [[lenguajeMY.smsSig(), `${usedPrefix + command}`], [`🥵 ${lenguajeMY.lenguaje() == 'es' ? 'porno yaoi 3' : 'nsfw yaoi 3'} 🥵`.toUpperCase(), `${usedPrefix}${lenguajeMY.lenguaje() == 'es' ? 'pornoyaoi3' : 'nsfwyaoi3'}`]], fkontak, m)}}
...
let enlace = await res[Math.floor(res.length * Math.random())]  
await conn.sendFile(m.chat, enlace, null, `${lenguajeMY['smsCont18Porn']()}\n${lenguajeMY['smsBotonM7']()} » ${user.premiumTime > 0 ? '✅' : '❌'}`, null, null, {viewOnce: false}, m)}
//await conn.sendButton(m.chat, lenguajeMY.smsCont18Porn(), ` *_${lenguajeMY['smsBotonM7']()}_* » ${user.premiumTime > 0 ? '✅' : '❌'}\n` + wm + ` : *${command[0].toUpperCase() + command.substring(1)}*`, enlace, [[lenguajeMY.smsSig(), `${usedPrefix + command}`], [`🥵 ${lenguajeMY.lenguaje() == 'es' ? 'porno yuri 2' : 'nsfw yuri 2'} 🥵`.toUpperCase(), `${usedPrefix}${lenguajeMY.lenguaje() == 'es' ? 'pornoyuri2' : 'nsfwyuri2'}`]], m, frep)}
...
await conn.sendFile(m.chat, stickerr, 'sticker.webp', '', m, true, { contextInfo: { 'forwardingScore': 200, 'isForwarded': false, externalAdReply:{ showAdAttribution: false, title: lenguajeMY.smsCont18PornP2(), body: wm, mediaType: 2, sourceUrl: redesMenu.getRandom(), thumbnail: await(await fetch(img16)).buffer()}}}, { quoted: m })
await conn.sendFile(m.chat, null, null, `${lenguajeMY['smsCont18Porn']()}\n${lenguajeMY['smsBotonM7']()} » ${user.premiumTime > 0 ? '✅' : '❌'}`, null, null, {viewOnce: false}, m)
//await conn.sendButton(m.chat, lenguajeMY.smsCont18Porn(), `*_${lenguajeMY['smsBotonM7']()}_* » ${user.premiumTime > 0 ? '✅' : '❌'}\n` + wm + ` : *${command[0].toUpperCase() + command.substring(1)}*`, null, [[lenguajeMY.smsSig(), `${usedPrefix + command}`], [`🥵 ${lenguajeMY.lenguaje() == 'es' ? 'porno yuri 3' : 'nsfw yuri 3'} 🥵`.toUpperCase(), `${usedPrefix}${lenguajeMY.lenguaje() == 'es' ? 'pornoyuri3' : 'nsfwyuri3'}`]], fkontak, m)
}else{
await conn.sendFile(m.chat, link, null, `${lenguajeMY['smsCont18Porn']()}\n${lenguajeMY['smsBotonM7']()} » ${user.premiumTime > 0 ? '✅' : '❌'}`, null, null, {viewOnce: false}, m)}}
//await conn.sendButton(m.chat, lenguajeMY.smsCont18Porn(), `*_${lenguajeMY['smsBotonM7']()}_* » ${user.premiumTime > 0 ? '✅' : '❌'}\n` + wm + ` : *${command[0].toUpperCase() + command.substring(1)}*`, link, [[lenguajeMY.smsSig(), `${usedPrefix + command}`], [`🥵 ${lenguajeMY.lenguaje() == 'es' ? 'porno yuri 3' : 'nsfw yuri 3'} 🥵`.toUpperCase(), `${usedPrefix}${lenguajeMY.lenguaje() == 'es' ? 'pornoyuri3' : 'nsfwyuri3'}`]], m, frep)}}

if (command == 'pornodarling' || command == 'nsfwdarling') { 
let list = global.darling
let link = list[Math.floor(Math.random() * list.length)]
await conn.sendFile(m.chat, link, null, `${lenguajeMY['smsCont18Porn']()}\n${lenguajeMY['smsBotonM7']()} » ${user.premiumTime > 0 ? '✅' : '❌'}`, null, null, {viewOnce: false}, m)}
//await conn.sendButton(m.chat, lenguajeMY.smsCont18Porn(), `*_${lenguajeMY['smsBotonM7']()}_* » ${user.premiumTime > 0 ? '✅' : '❌'}\n` + wm + ` : *${command[0].toUpperCase() + command.substring(1)}*`, link, [[lenguajeMY.smsSig(), `${usedPrefix + command}`], [lenguajeMY.lenguaje() == 'es' ? '🔞 ver lista porno 🔞'.toUpperCase() : '🔞 list horny🔞 '.toUpperCase(), lenguajeMY.lenguaje() == 'es' ? usedPrefix + 'listaporno' : usedPrefix + 'listhorny']], m, frep)}
...
let link = list[Math.floor(Math.random() * list.length)]
await conn.sendFile(m.chat, link, null, `${lenguajeMY['smsCont18Porn']()}\n${lenguajeMY['smsBotonM7']()} » ${user.premiumTime > 0 ? '✅' : '❌'}`, null, null, {viewOnce: false}, m)}
//await conn.sendButton(m.chat, lenguajeMY.smsCont18Porn(), `*_${lenguajeMY['smsBotonM7']()}_* » ${user.premiumTime > 0 ? '✅' : '❌'}\n` + wm + ` : *${command[0].toUpperCase() + command.substring(1)}*`, link, [[lenguajeMY.smsSig(), `${usedPrefix + command}`], [`🥵 ${lenguajeMY.lenguaje() == 'es' ? 'porno pack chica' : 'nsfw pack girl'} 🥵`.toUpperCase(), `${usedPrefix}${lenguajeMY.lenguaje() == 'es' ? 'pornopackchica' : 'nsfwpackgirl'}`], [`🥵 ${lenguajeMY.lenguaje() == 'es' ? 'porno pack chico' : 'nsfw pack men'} 🥵`.toUpperCase(), `${usedPrefix}${lenguajeMY.lenguaje() == 'es' ? 'pornopackchico' : 'nsfwpackmen'}`]], m, frep)}
