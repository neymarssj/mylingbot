...
fake = { contextInfo: { externalAdReply: { title: `🌟 NUEVO LOGRO 🌟`, body: `Califica personajes, es gratis ❤️`, sourceUrl: accountsmy.getRandom(), thumbnailUrl: gataMenu.getRandom() }}}
...
fake = { contextInfo: { externalAdReply: { title: `🌟 RECOMPENSA 🌟`, body: `Usa #fymy para ver más desafíos`, sourceUrl: accountsmy.getRandom(), thumbnailUrl: gataMenu.getRandom() }}}
...
fake = { contextInfo: { externalAdReply: { title: `SIGUE DANDO 👍`, body: `Califica persoanjes, es gratis 👍`, sourceUrl: accountsmy.getRandom(), thumbnailUrl: gataMenu.getRandom() }}}
...
fake = { contextInfo: { externalAdReply: { title: `SIGUE DANDO ❤️`, body: `Califica persoanjes, es gratis ❤️`, sourceUrl: accountsmy.getRandom(), thumbnailUrl: gataMenu.getRandom() }}}
