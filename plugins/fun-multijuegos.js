...
if (command == 'multijuegos') { 
  global.db.data.users[m.sender].limit += 1
              ...
              //let gata = `${pickRandom([`𝙋𝙪𝙚𝙙𝙚𝙨 𝙂𝙖𝙣𝙖𝙧 𝘿𝙞𝙖𝙢𝙖𝙣𝙩𝙚𝙨 𝙖𝙡 𝙅𝙪𝙜𝙖𝙧!!`,`𝙎𝙞𝙜𝙪𝙚 𝙟𝙪𝙜𝙖𝙣𝙙𝙤 𝙥𝙖𝙧𝙖 𝙜𝙖𝙣𝙖𝙧 𝗠𝘆𝗹𝗶𝗻𝗴𝗖𝗼𝗶𝗻𝘀!!`,`𝙎𝙖𝙗𝙞𝙖𝙨 𝙦𝙪𝙚 𝙥𝙪𝙚𝙙𝙚𝙨 𝙂𝙖𝙣𝙖𝙧 𝙀𝙭𝙥𝙚𝙧𝙞𝙚𝙣𝙘𝙞𝙖 𝙖𝙡 𝙅𝙪𝙜𝙖𝙧? 𝘼𝙝𝙤𝙧𝙖 𝙮𝙖 𝙡𝙤 𝙨𝙖𝙗𝙚𝙨!!`])}`
            //let s = `Bienvenido al Multijuegos Aleeatorios`

 const templateButtonsReplyMessage = [
{index: 1, urlButton: {displayText: '𝗠𝘆𝗹𝗶𝗻𝗴𝗕𝗼𝘁-𝗠𝗗', url: 'https://github.com/WilsonOFC/MylingBot-MD/'}},
...
{index: 5, quickReplyButton: {displayText: '𝙑𝙤𝙡𝙫𝙚𝙧 𝙖𝙡 𝙈𝙚𝙣𝘂 👻 | 𝘽𝙖𝙘𝙠 𝙩𝙤 𝙈𝙚𝙣𝙪 ☘️', id: '#menu'}},
]
 
let t = {
text: global.wm,
footer: `¡¡¡💥💫𝘽𝙞𝙚𝙣𝙫𝙚𝙣𝙞𝙙𝙤(𝙖) ${username}\n, 𝗩𝗲𝗻 𝗮 𝗲𝗻𝘁𝗿𝗲𝘁𝗲𝗻𝗲𝗿𝘁𝗲 𝗰𝗼𝗻 𝗻𝘂𝗲𝘀𝘁𝗿𝗮 𝗮𝗺𝗽𝗹𝗶𝗮 𝗴𝗮𝗺𝗮 𝗱𝗲 𝗷𝘂𝗲𝗴𝗼𝘀 💫💥!!!`,
...
conn.sendMessage(m.chat, t, m)
  ...
  if (command == 'juegos') { 
    ...
    let gata = `${pickRandom([`𝙋𝙪𝙚𝙙𝙚𝙨 𝙂𝙖𝙣𝙖𝙧 𝘿𝙞𝙖𝙢𝙖𝙣𝙩𝙚𝙨 𝙖𝙡 𝙅𝙪𝙜𝙖𝙧!!`,`𝙎𝙞𝙜𝙪𝙚 𝙟𝙪𝙜𝙖𝙣𝙙𝙤 𝙥𝙖𝙧𝙖 𝙜𝙖𝙣𝙖𝙧 𝗠𝘆𝗹𝗶𝗻𝗴𝘾𝙤𝙞𝙣𝙨!!`,`𝙎𝙖𝙗𝙞𝙖𝙨 𝙦𝙪𝙚 𝙥𝙪𝙚𝙙𝙚𝙨 𝙂𝙖𝙣𝙖𝙧 𝙀𝙭𝙥𝙚𝙧𝙞𝙚𝙣𝙘𝙞𝙖 𝙖𝙡 𝙅𝙪𝙜𝙖𝙧? 𝘼𝙝𝙤𝙧𝙖 𝙮𝙖 𝙡𝙤 𝙨𝙖𝙗𝙚𝙨!!`])}`
             let c = `${usedPrefix}`
              ...
              let ss = await `𝗠𝘆𝗹𝗶𝗻𝗴𝗕𝗼𝘁-𝗠𝗗 | 𝗪𝗶𝗹𝘀𝗼𝗻𝗢𝗙𝗖`
...
conn.sendMessage(m.chat, tt, m)
 ...
 if (command == 'juegos') {
   ...
   let gata = `${pickRandom([`𝘿𝙚𝙢𝙪𝙚𝙨𝙩𝙧𝙖 𝙦𝙪𝙚 𝘁𝗮𝗻 𝘁𝗿𝘆𝗵𝗮𝗿𝗱 𝘀𝗼𝘀 𝗘𝗦𝗙𝗨𝗘𝗥𝗭𝗔𝗧𝗘 𝗣𝗔𝗥𝗔 𝗟𝗢𝗚𝗥𝗔𝗥 𝗘𝗟 𝗧𝗢𝗣 1!!`,`𝙈𝙞𝙚𝙣𝙩𝙧𝙖𝙨 𝙢𝙖𝙨 𝙅𝙪𝙚𝙜𝙖𝙨 𝙩𝙪 𝙍𝙖𝙣𝙜𝙤 𝙩𝙖𝙢𝙗𝙞𝙚𝙣 𝙨𝙪𝙗𝙞𝙧𝙖!!`,`𝙋𝙖𝙧𝙩𝙞𝙘𝙞𝙥𝙖 𝙚𝙣 𝙚𝙡 𝙢𝙤𝙙𝙤 𝙈𝙪𝙡𝙩𝙞𝙟𝙪𝙚𝙜𝙤𝙨 𝙮 𝙂𝙖𝙣𝙖 𝙧𝙚𝙘𝙤𝙢𝙥𝙚𝙣𝙨𝙖𝙨!!`])}`
            let c = `${usedPrefix}`
           ...
           let sss = await `𝗠𝘆𝗹𝗶𝗻𝗴𝗕𝗼𝘁-𝗠𝗗 | 𝗪𝗶𝗹𝘀𝗼𝗻𝗢𝗙𝗖`
...
conn.sendMessage(m.chat, ttt, m)
  ...
  if (command == 'juegos') { 
    ...
    let gata = `${pickRandom([`𝙀𝙡𝙞𝙟𝙚 𝙏𝙪 𝙀𝙢𝙤𝙟𝙞 𝙁𝙖𝙫𝙤𝙧𝙞𝙩𝙤 𝙥𝙖𝙧𝙖 𝙅𝙪𝙜𝙖𝙧!!`,`𝘼𝙙𝙞𝙫𝙞𝙣𝙖 𝙚𝙡 𝙋𝙧𝙤𝙭𝙞𝙢𝙤 𝙅𝙪𝙚𝙜𝙤!!`,`𝘼𝙙𝙞𝙫𝙞𝙣𝙖 𝙚𝙡 𝙋𝙧𝙤𝙭𝙞𝙢𝙤 𝙅𝙪𝙚𝙜𝙤!!`,`𝙈𝙞𝙣𝙞𝙟𝙪𝙚𝙜𝙤𝙨 𝙚𝙨𝙩á𝙣 𝙚𝙨𝙥𝙚𝙧𝙖𝙣𝙙𝙤 𝙚𝙣 𝙨𝙚𝙧 𝙅𝙪𝙜𝙖𝙙𝙤𝙨!!`])}`
                 ...
                 let ssss = await `𝗠𝘆𝗹𝗶𝗻𝗴𝗕𝗼𝘁-𝗠𝗗 | 𝗪𝗶𝗹𝘀𝗼𝗻𝗢𝗙𝗖`
