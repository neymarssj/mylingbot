...
if (!text) {
if (!usuarioExistente) {
fake = { contextInfo: { externalAdReply: { title: `🌟 ¡Colecciona Personajes!`, body: `Compra un personaje y vuelve aquí`, sourceUrl: accountsmy.getRandom(), thumbnailUrl: gataMenu.getRandom() }}}
...
fake = { contextInfo: { externalAdReply: { title: `😅 ¡No tienes Personajes!`, body: `Vuelve a comprar y regresa aquí`, sourceUrl: accountsmy.getRandom(), thumbnailUrl: gataMenu.getRandom() }}}
...
fake = { contextInfo: { externalAdReply: { title: `🤨 ¡Verifique el nombre o código!`, body: `Escriba ${usedPrefix + command} para ver sus personajes`, sourceUrl: accountsmy.getRandom(), thumbnailUrl: gataMenu.getRandom() }}}
...
fake = { contextInfo: { externalAdReply: { title: `🌟 Personajes de clase: ${imageClass}`, body: `Puedes hacer un solo cambio por 🤩🎟️`, sourceUrl: accountsmy.getRandom(), thumbnailUrl: gataMenu.getRandom() }}}
...
fake = { contextInfo: { externalAdReply: { title: `✅ ¡Personaje ${personaje} cambiado!`, body: `🎟️ Tienes Premium por: ${tiempoPremiumFormateado} `, sourceUrl: accountsmy.getRandom(), thumbnailUrl: imageURL }}}
...
const tiempoTotalFormateado = formatearTiempo(tiempoTotal * 60 * 1000, true)
fake = { contextInfo: { externalAdReply: { title: `✅ ¡${personajesMismaClase.length} Personajes cambiados!`, body: `🎟️ Tienes Premium por: ${tiempoPremiumFormateado} `, sourceUrl: accountsmy.getRandom(), thumbnailUrl: gataMenu.getRandom() }}}
