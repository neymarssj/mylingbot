...
╰─ ❖ ── ✦ ── ✧ ── ✦ ── ❖ ──╝`
await conn.sendFile(m.chat, picture, 'Hola.mp3', estado, fkontak, false, { contextInfo: {externalAdReply :{ mediaUrl: null, mediaType: 1, description: null, title: gt, body: ' 𝑴𝒚𝒍𝒊𝒏𝒈𝑩𝒐𝒕-𝑴𝑫 ', previewType: 0, thumbnail: gataMenu, sourceUrl: redesMenu }}})
/*let estado =`
╭━━━━[ *𝙀𝙎𝙏𝘼𝘿𝙊 | 𝙎𝙏𝘼𝙏𝙐𝙎* ]━━━━━⬣
┃💗 *¡Hola | Hi!* ${name}
┃┈┈┈┈┈┈┈┈┈┈┈┈┈┈┈┈┈ 
