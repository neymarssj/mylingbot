...
fake = { contextInfo: { externalAdReply: { title: `Transfiera a otro Usuario 🧐`, body: `Algo no salió bien...`, sourceUrl: accountsmy.getRandom(), thumbnailUrl: gataMenu.getRandom() }}}
...
fake = { contextInfo: { externalAdReply: { title: `❌ Parámetros incompletos`, body: `Algo no salió bien...`, sourceUrl: accountsmy.getRandom(), thumbnailUrl: gataMenu.getRandom() }}}
...
fake = { contextInfo: { externalAdReply: { title: `✋ Decidió no continuar`, body: `No se hizo transferencia`, sourceUrl: accountsmy.getRandom(), thumbnailUrl: gataMenu.getRandom() }}}
