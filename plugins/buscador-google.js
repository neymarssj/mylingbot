...
if (!text) throw `${lenguajeMY['smsAvisoMG']()}Hᴏʟᴀ, ᴜsᴏ ᴇʀʀᴏɴᴇᴏ ᴅᴇʟ ᴄᴏᴍᴀɴᴅᴏ \nEᴊᴇᴍᴘʟᴏs:\n*${usedPrefix + command} Mᴇssɪ*\n\nTʀᴀᴛᴀ ᴅᴇ ʙᴜsᴄᴀʀ ᴄᴏsᴀs ᴠᴀʟɪᴅᴀs\nOᴛʀᴏ ᴇᴊᴇᴍᴘʟᴏ:\n*${usedPrefix + command} CR7*`
try {
const url = 'https://google.com/search?q=' + encodeURIComponent(text);
google({'query': text}).then(res => {
let teks = `*💻 Rᴇsᴜʟᴛᴀᴅᴏs ᴅᴇ:* ${text}\n\n*${url}*\n\n`
for (let g of res) {
teks += `_${g.title}_\n_${g.link}_\n_${g.snippet}_\n\n┈┈┈┈┈┈┈┈┈┈┈┈┈┈┈┈┈\n\n`
} 
...
let text = args.join` `
if (!text) return conn.reply(m.chat, `${lenguajeMY['smsAvisoMG']()}𝙀𝙎𝘾𝙍𝙄𝘽𝘼 𝙇𝙊 𝙌𝙐𝙀 𝙌𝙐𝙄𝙀𝙍𝙀 𝘽𝙐𝙎𝘾𝘼𝙍\n𝙀𝙅𝙀𝙈𝙋𝙇𝙊\n*${usedPrefix + command} Fantasma*\n\n𝙏𝙔𝙋𝙀 𝙒𝙃𝘼𝙏 𝙔𝙊𝙐 𝙒𝘼𝙉𝙏 𝙏𝙊 𝙎𝙀𝘼𝙍𝘾𝙃 𝙁𝙊𝙍\n𝙀𝙓𝘼𝙈𝙋𝙇𝙀\n*${usedPrefix + command} Ghost*`, m)
