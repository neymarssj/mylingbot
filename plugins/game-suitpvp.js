...
let textno = `${lenguajeMY['smsAvisoAG']()} @${room.p2.split`@`[0]} 𝙍𝙀𝘾𝙃𝘼𝙕𝙊 𝙀𝙇 𝙋𝙑𝙋, 𝙀𝙇 𝙅𝙐𝙀𝙂𝙊 𝙎𝙀 𝘾𝘼𝙉𝘾𝙀𝙇𝘼`
...
let textplay = `${lenguajeMY['smsAvisoIIG']()}🎮 𝙀𝙇 𝙅𝙐𝙀𝙂𝙊𝙎 𝘾𝙊𝙈𝙄𝙀𝙉𝙕𝘼, 𝙇𝘼𝙎 𝙊𝙋𝘾𝙄𝙊𝙉𝙀𝙎 𝙃𝘼𝙉 𝙎𝙄𝘿𝙊 𝙀𝙉𝙑𝙄𝘼𝘿𝙊𝙎 𝘼 𝙇𝙊𝙎 𝘾𝙃𝘼𝙏 𝙋𝙍𝙄𝙑𝘼𝘿𝙊 𝘿𝙀 @${room.p.split`@`[0]} 𝙔 @${room.p2.split`@`[0]}\n\n𝙎𝙀𝙇𝙀𝘾𝘾𝙄𝙊𝙉𝙀𝙉 𝙐𝙉𝘼 𝙊𝙋𝘾𝙄𝙊𝙉 𝙀𝙉 𝙎𝙐𝙎 𝘾𝙃𝘼𝙏𝙎 𝙋𝙍𝙄𝙑𝘼𝘿𝙊 𝙍𝙀𝙎𝙋𝙀𝘾𝙏𝙄𝙑𝘼𝙈𝙀𝙉𝙏𝙀\n\n*Elegir opción en wa.me/${conn.user.jid.split`@`[0]}*`
m.reply(textplay, m.chat, {mentions: this.parseMention(textplay)})
let comienzop = `${lenguajeMY['smsAvisoIIG']()}𝙋𝙊𝙍 𝙁𝘼𝙑𝙊𝙍 𝙎𝙀𝙇𝙀𝘾𝘾𝙄𝙊𝙉𝙀 𝙐𝙉𝘼 𝘿𝙀 𝙇𝘼𝙎 𝙎𝙄𝙂𝙐𝙄𝙀𝙉𝙏𝙀𝙎 𝙊𝙋𝘾𝙄𝙊𝙉𝙀𝙎\n\nღ Piedra\nდ Papel\nღ Tijera\n\n*Responda al mensaje con la opción*`
let comienzop2 = `${lenguajeMY['smsAvisoIIG']()}𝙋𝙊𝙍 𝙁𝘼𝙑𝙊𝙍 𝙎𝙀𝙇𝙀𝘾𝘾𝙄𝙊𝙉𝙀 𝙐𝙉𝘼 𝘿𝙀 𝙇𝘼𝙎 𝙎𝙄𝙂𝙐𝙄𝙀𝙉𝙏𝙀𝙎 𝙊𝙋𝘾𝙄𝙊𝙉𝙀𝙎\n\nღ Piedra\nღ Papel\nღ Tijera\n\n*Responda al mensaje con la opción*`
...
let iniciativa = `${lenguajeMY['smsAvisoAG']()}𝙉𝙄𝙉𝙂𝙐𝙉 𝙅𝙐𝙂𝘼𝘿𝙊𝙍 𝙏𝙊𝙈𝙊 𝙇𝘼 𝙄𝙉𝙄𝘾𝙄𝘼𝙏𝙄𝙑𝘼 𝘿𝙀 𝙀𝙈𝙋𝙀𝙕𝘼𝙍 𝙀𝙇 𝙅𝙐𝙀𝙂𝙊𝙎, 𝙀𝙇 𝙋𝙑𝙋 𝙎𝙀 𝘼𝙃 𝘾𝘼𝙉𝘾𝙀𝙇𝘼𝘿𝙊`                              
if (!room.pilih && !room.pilih2) this.sendMessage(m.chat, { text: iniciativa }, { quoted: fkontak })
else if (!room.pilih || !room.pilih2) {
win = !room.pilih ? room.p2 : room.p 
let textnull = `${lenguajeMY['smsAvisoAG']()} @${(room.pilih ? room.p2 : room.p).split`@`[0]} 𝙉𝙊 𝙀𝙇𝙀𝙂𝙄𝙎𝙏𝙀 𝙉𝙄𝙉𝙂𝙐𝙉𝘼 𝙊𝙋𝘾𝙄𝙊𝙉, 𝙁𝙄𝙉 𝘿𝙀𝙇 𝙋𝙑𝙋`
...
if (!room.pilih2) this.reply(room.p2, `${lenguajeMY['smsAvisoIIG']()}𝙀𝙇 𝙊𝙋𝙊𝙉𝙀𝙉𝙏𝙀 𝘼𝙃 𝙀𝙇𝙀𝙂𝙄𝘿𝙊, 𝙀𝙎 𝙏𝙐 𝙏𝙐𝙍𝙉𝙊 𝘿𝙀 𝙀𝙇𝙀𝙂𝙄𝙍`, fkontak, 0)}
if (jwb2 && reg.test(m.text) && !room.pilih2 && !m.isGroup) {
room.pilih2 = reg.exec(m.text.toLowerCase())[0]
room.text2 = m.text
m.reply(`✅ 𝙃𝘼𝙎 𝙀𝙇𝙀𝙂𝙄𝘿𝙊 ${m.text}, 𝙍𝙀𝙂𝙍𝙀𝙎𝘼 𝘼𝙇 𝙂𝙍𝙐𝙋𝙊 𝙔 ${room.pilih ? `*𝙍𝙀𝙑𝙄𝙎𝘼 𝙇𝙊𝙎 𝙍𝙀𝙎𝙐𝙇𝙏𝘼𝘿𝙊𝙎*` : '*𝙀𝙎𝙋𝙀𝙍𝘼 𝙇𝙊𝙎 𝙍𝙀𝙎𝙐𝙇𝙏𝘼𝘿𝙊𝙎*'}`)
if (!room.pilih) this.reply(room.p, `${lenguajeMY['smsAvisoIIG']()}𝙀𝙇 𝙊𝙋𝙊𝙉𝙀𝙉𝙏𝙀 𝘼𝙃 𝙀𝙇𝙀𝙂𝙄𝘿𝙊, 𝙀𝙎 𝙏𝙐 𝙏𝙐𝙍𝙉𝙊 𝘿𝙀 𝙀𝙇𝙀𝙂𝙄𝙍`, fkontak, 0)}
