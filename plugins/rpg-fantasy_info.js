...
*¿Te gustaría proponer tus propios personajes para que formen parte de MylingBot?*
¡Es sencillo! Solo utiliza el comando *${usedPrefix}fyadd* o *${usedPrefix}fantasyadd* y sigue la guía proporcionada para comenzar a crear tu solicitud de personajes. Los desarrolladores estarán encantados de recibir tus propuestas y considerarlas para enriquecer la experiencia en MylingBot-MD. 
`.trim()
