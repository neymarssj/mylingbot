...
export function protoType() {
    ...
    Number.prototype.toTimeString = function toTimeString() {
        ...
        return (
(days ? `${days} ${lenguajeMY.smsAfkResultTime[0]} ` : '') + (hours ? `${hours} ${lenguajeMY.smsAfkResultTime[1]} ` : '') +
(minutes ? `${minutes} ${lenguajeMY.smsAfkResultTime[2]} ` : '') + (seconds ? `${seconds} ${lenguajeMY.smsAfkResultTime[3]}` : '')).trim()
    }
