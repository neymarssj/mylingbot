...
const smsLista1 = () => { return `🌟 معلومات MYLINGBOT 🌟`}
...
const smsLista7 = () => { return `🌟 تثبيت MYLINGBOT 🌟`}
...
//_allantilink.js
const smsTextoYT = () => { return 'سوبر ميلينجبوت-MD-واتساب 👻'}
...
const smsCont7 = () => { return `${global.lenguajeMY['smsAvisoAG']()}*ليس لديها ماسات!! 💎 يمكنك الذهاب إلى المتجر باستخدام الأمر*`}
const smsCont8 = () => { return ` *الماس 💎 تستخدم*`}
const smsCont9 = () => { return `${global.lenguajeMY['smsAvisoAG']()}*بحاجة إلى المستوى ➡️*`}
...
//_antilink.js
const smsAdwa = () => { return `${global.lenguajeMY['smsAvisoEG']()}*نظرًا لأنك مسؤول في هذه المجموعة ، فلن تتم إزالتك*`}
const smsEnlaceWat = () => { return `${lenguajeMY['smsAvisoAG']()}*تم اكتشاف رابط WHATSAPP محظور في هذه المجموعة*\n\n*لقد شرعت في حذفك*`}

//_antilink2.js
const smsEnlaceWatt = () => { return `${lenguajeMY['smsAvisoAG']()}تم اكتشاف ارتباط محظور يحتوي على HTTPS في هذه المجموعة\n\nلقد شرعت في حذفك`}
...
//خطأ
const smsMalError = () => { return `${lenguajeMY['smsAvisoFG']()}\`\`\`لقد حدث خطأ غير متوقع.\`\`\``}
const smsMalError2 = () => { return `${lenguajeMY['smsAvisoFG']()}\`\`\`لقد نشأ إزعاج. حاول مرة أخرى.\`\`\``}
const smsMalError3 = () => { return `${lenguajeMY['smsAvisoFG']()}\`\`\`حدث خطأ ما ، أبلغ عن هذا الأمر باستخدام:\`\`\`\n`}
...
const smsModP2 = () => { return `تمكين الوظيفة حتى يتمكن الجميع من استخدام MylingBot`}
const smsModAd1 = () => { return `🛂 وضع المشرف`}
const smsModAd2 = () => { return `سيتمكن المسؤولون فقط من استخدام MylingBot في المجموعات`}
...
//_autosticker.js
const smsAutoStik = () => { return `${lenguajeMY['smsAvisoFG']()}*يجب ألا يزيد الفيديو عن 7 ثوانٍ.*`} 
...
//afk-afk.js
const smsAfkQ1 = (usedPrefix, command) => { return `${lenguajeMY['smsAvisoMG']()}*اكتب سبب عدم نشاطه (AFK)*\n\n*مثال:*\n*${usedPrefix + command}* انا ذاهب للقيام بالواجب المنزلي`} 
const smsAfkQ2 = () => { return `${lenguajeMY['smsAvisoMG']()}*يجب أن يكون هناك 10 أحرف على الأقل هي السبب*`} 
const smsAfkM1A = () => { return `*لا تضع علامة على*`} 
const smsAfkM1B = () => { return `*سيكون AFK غير نشط*\n\n*سبب عدم نشاط AFK:*`} 

//anonymous_chat.js
const smsChatAn1 = () => { return `${lenguajeMY['smsAvisoFG']()}*أنت لست في دردشة مجهولة*`} 
...
const smsChatAn4 = () => { return `${lenguajeMY['smsAvisoRG']()}🪐 *لقد تركت الدردشة المجهولة*`} 
const smsChatAn5 = () => { return `${lenguajeMY['smsAvisoAG']()}*ترك المستخدم الآخر الدردشة المجهولة*`}  
const smsChatAn6 = () => { return `*إذا كنت تريد الذهاب إلى دردشة أخرى مجهولة ، فاستخدم الأمر #start أو استخدم الزر أدناه*\n`} 
const smsChatAn7 = () => { return `${lenguajeMY['smsAvisoAG']()}*أنت لا تزال في دردشة مجهولة أو تنتظر أن ينضم شخص ما إلى الدردشة*`} 
...
const smsChatAn10 = () => { return `${lenguajeMY['smsAvisoEG']()}✨ *يمكنهم الدردشة الآن*`} 
const smsChatAn11 = () => { return `*شخص ما انضم إلى الدردشة المجهولة!!*`} 
const smsChatAn12 = () => { return `❇️ مستخدم آخر`} 
const smsChatAn13 = () => { return `${lenguajeMY['smsAvisoRG']()}🐈 *في انتظار انضمام شخص ما إلى الدردشة المجهولة ، يرجى التحلي بالصبر*`} 
...
const smsMalused2 = () => { return `${lenguajeMY['smsAvisoMG']()}🐈 *يجب عليك استخدام الأمر مثل هذا المثال:*\n`}
const smsMalused3 = () => { return `${lenguajeMY['smsAvisoMG']()}🐈 *يجب عليك استخدام الأمر أو الرد على رسالة شخص ما مثل هذا المثال:*\n`}
...
//grupo-add.js
const smsAddB1 = () => { return `${lenguajeMY['smsAvisoFG']()}*لا يمكن إضافة الرقم ، يرجى التحقق من صحته ، أو ربما خرج مؤخرًا أو تم تعيين خصوصيتك.*`}
const smsAddB2 = () => { return `${lenguajeMY['smsAvisoFG']()}*لا يمكن إضافة الرقم أو التحقق من صحته أو إضافته يدويًا.*`}
...
const smsAdveu1 = () => { return `${lenguajeMY['smsAvisoAG']()}*يمكن استخدامه فقط في حالة تنشيط الوظيفة:*\n`}
const smsAdveu2 = () => { return 'سبب'}
const smsAdveu3 = () => { return `${lenguajeMY['smsAvisoMG']()}*تذكر أن تكتب سبب التحذير*\n`}
...
//grupo-kick.js
const smskick1 = () => { return `${lenguajeMY['smsAvisoAG']()}*ضع علامة على الشخص أو رد على رسالة الشخص الذي تريد حذفه*\n\n*مثال: `}
...
//grupo-setbye.js
const smsSetB = () => { return `${lenguajeMY['smsAvisoEG']()}*تم تكوين وداع المجموعة*`}
const smsSetB2 = () => { return `${lenguajeMY['smsAvisoIIG']()}🙌 *_اكتب رسالة الوداع_*\n*_اختياري يمكنك استخدام ما هو مع "@" لإضافة المزيد من المعلومات:_*\n\n*⚡ @user (أذكر للمستخدم)*\n\n*تذكر أن علامة "@" هي اختيارية*`}

//grupo-setwelcome.js
const smsSetW = () => { return `${lenguajeMY['smsAvisoEG']()}*تم إعداد ترحيب المجموعة*`}
const smsSetW2 = () => { return `${lenguajeMY['smsAvisoIIG']()}🙌 *_اكتب رسالة الترحيب_*\n*_اختياري يمكنك استخدام ما هو مع "@" لإضافة المزيد من المعلومات:_*\n\n*⚡ @user (أذكر للمستخدم)*\n*⚡ @subject (أسم المجموعة)*\n*⚡ @desc (وصف المجموعة)*\n\n*تذكر أن علامة "@" اختيارية*`}

//grupo-setdesc.js
const smsDest = () => { return `${lenguajeMY['smsAvisoEG']()}*تم تكوين وصف المجموعة*`}

//grupo-setname.js
const smsNam1 = () => { return `${lenguajeMY['smsAvisoEG']()}*تم تعيين اسم المجموعة*`}
const smsNam2 = () => { return `${lenguajeMY['smsAvisoMG']()}*🙌 اكتب اسم المجموعة الجديد*`}
const smsNam3 = () => { return `${lenguajeMY['smsAvisoFG']()}*يجب ألا يحتوي اسم المجموعة على أكثر من 25 حرفًا*`}

//grupo-restaurarEnlace.js
const smsRestGp = () => { return `${lenguajeMY['smsAvisoEG']()}*تمت إعادة تعيين ارتباط المجموعة*`}
...
//propietario(a.js
const smsPropban1 = (usedPrefix, command, bot) => { return `${lenguajeMY['smsAvisoMG']()}*ضع علامة على أحد الأشخاص أو رد على رسالة المستخدم أو اكتب الرقم الذي تريد حظره من الأوامر*\n\n*مثال:*\n*${usedPrefix + command} @${bot}*`}
const smsPropban2 = (bot) => { return `${lenguajeMY['smsAvisoFG']()}*@${bot} لا يمكن حظره بهذا الأمر* 😹`}
const smsPropban3 = (ownerNumber) => { return `${lenguajeMY.smsAvisoIIG()}😳 *لا يمكنني منع المالك @${ownerNumber} من ${packname}*`}
const smsPropban4 = (number) => { return `${lenguajeMY.smsAvisoIIG()}*ليس من الضروري الحظر مرة أخرى @${number} نعم إنه موجود بالفعل* 😊`}
const smsPropban5 = () => { return `${lenguajeMY['smsAvisoEG']()}*المستخدم محظور بنجاح* 🙀`}
const smsPropban6 = (number, usr) => { return `${lenguajeMY.smsAvisoAG()}*@${number} أنت محظور من قبل @${usr} لا يمكنك استخدام الأوامر حتى يقوم أحدهم بعكس الحظر* 😿`}
const smsPropban7 = (usedPrefix, command, number) => { return `${lenguajeMY['smsAvisoFG']()}*ظهر خطأ ، ربما يكون المستخدم غير موجود في قاعدة بياناتي ، حاول الكتابة ${usedPrefix + command} ${number}*\n\`\`\`إذا استمر الخطأ في الإبلاغ عن هذا الأمر\`\`\``}
...
*➡️ باستخدام هاتف خلوي أو كمبيوتر شخصي آخر ، امسح رمز الاستجابة السريعة هذا ليصبح روبوتًا فرعيًا*\n\n*1️⃣ انتقل إلى النقاط الثلاث في الزاوية اليمنى العليا*\n*2️⃣ انتقل إلى خيار الأجهزة المقترنة*\n*3️⃣ امسح رمز الاستجابة السريعة هذا لتسجيل الدخول*`}
const smsJBConexionClose2 = () => { return `${lenguajeMY['smsAvisoFG']()}🔴 *تم فصل الجهاز*\n\n*سيكون عليك الاتصال مرة أخرى للاستخدام:\n#deletesesion`}
const smsreenvia = () => { return `*🟢 أعد إرسال الأمر...*`}
const smsSoloOwnerJB = () => { return `${lenguajeMY['smsAvisoAG']()}*تم تعطيل هذا الأمر من قبل المالك*`}
const smsJBPrincipal = () => { return `${lenguajeMY['smsAvisoAG']()}🔵 *لكي تكون تابعًا ثانويًا ، انتقل إلى الرقم الرئيسي*\n*ღ أدخل الرابط التالي:*\n`}
const smsJBConexion = () => { return `${lenguajeMY['smsAvisoFG']()}🟡 *تم إغلاق الاتصال بطريقة غير متوقعة ، سنحاول إعادة الاتصال ...*`}
const smsJBConexionClose = () => { return `${lenguajeMY['smsAvisoFG']()}🔴 *تم إغلاق الاتصال ، يجب عليك الاتصال يدويًا باستخدام الأمر #jadibot وإعادة إنشاء رمز الاستجابة السريعة الجديد*`}
const smsJBConexionTrue = () => { return `${lenguajeMY['smsAvisoEG']()}🟢 *اتصال ناجح!!!*`}
const smsJBConexionTrue2 = () => { return `${lenguajeMY['smsAvisoEG']()}🟢 *اتصال ناجح!!! يمكنك الاتصال باستخدام:*`}
const smsJBCargando = () => { return `${lenguajeMY['smsAvisoIIG']()}⚪ *متصل!! يرجى الانتظار يتم تحميل الرسائل ...*\n\n♻️ *الخيارات المتاحة:*\n*» #stop _(ميزة Stop Sub Bot)_*\n*» #deletesesion _(احذف كل آثار Sub Bot)_*\n*» #jadibot _(احصل على رمز QR جديد ليكون Sub Bot)_*`}
...
const smsJBDel = () => { return `${lenguajeMY['smsAvisoAG']()}*استخدم هذا الأمر مع الروبوت الرئيسي*`}
const smsJBAdios = () => { return `${lenguajeMY['smsAvisoEG']()}*سأفتقدك ${global.packname} وداعا!! 🥹*`}
const smsJBCerrarS = () => { return `${lenguajeMY['smsAvisoEG']()}*لقد قمت بتسجيل الخروج وحذف جميع المسارات*`}
const smsJBErr = () => { return `*لقد قمت بتسجيل الخروج كبرنامج ثانوي* ♻️`}

//comandos+18-adult.js
const smsContAdult = () => { return `${lenguajeMY['smsAvisoAG']()}*الأوامر 🔞 إنهم معاقون ، إذا كنت منشئ المحتوى الخاص بي #on modohorny*`}
...
const smsContacto4 = () => { return 'جهة اتصال MylingBot الرسمية 👻'}
