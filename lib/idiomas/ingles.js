...
const smsLista1 = () => { return `🌟 MYLINGBOT INFORMATION 🌟`}
...
const smsLista7 = () => { return `🌟 INSTALL MYLINGBOT 🌟`}
...
const smsCont7 = () => { return `${global.lenguajeMY['smsAvisoAG']()}*DOESN'T HAVE DIAMONDS!! 💎 YOU CAN GO TO THE STORE WITH THE COMMAND*`}
const smsCont8 = () => { return ` *DIAMOND 💎 USED*`}
const smsCont9 = () => { return `${global.lenguajeMY['smsAvisoAG']()}*NEED THE LEVEL ➡️*`}
...
//_antilink.js
const smsAdwa = () => { return `${global.lenguajeMY['smsAvisoEG']()}*AS YOU ARE ADMIN IN THIS GROUP YOU WILL NOT BE REMOVED*`}
const smsEnlaceWat = () => { return `${lenguajeMY['smsAvisoAG']()}*A BANNED WHATSAPP LINK WAS DETECTED IN THIS GROUP*\n\n*I PROCEED TO DELETE YOU*`}


//_antilink2.js
const smsEnlaceWatt = () => { return `${lenguajeMY['smsAvisoAG']()}A FORBIDDEN LINK CONTAINING HTTPS WAS DETECTED IN THIS GROUP\n\nI PROCEED TO DELETE YOU`}
...
//Error
const smsMalError = () => { return `${lenguajeMY['smsAvisoFG']()}\`\`\`AN UNEXPECTED ERROR HAS OCCURRED.\`\`\``}
const smsMalError2 = () => { return `${lenguajeMY['smsAvisoFG']()}\`\`\`AN INCONVENIENCE HAS ARISEN. TRY AGAIN.\`\`\``}
const smsMalError3 = () => { return `${lenguajeMY['smsAvisoFG']()}\`\`\`SOMETHING WENT WRONG, REPORT THIS COMMAND USING:\`\`\`\n`}
...
const smsModP2 = () => { return `Enable function so everyone can use MylingBot`}
const smsModAd1 = () => { return `🛂 ADMIN MODE`}
const smsModAd2 = () => { return `Only Admins will be able to use MylingBot in Groups`}
...
//_autosticker.js
const smsAutoStik = () => { return `${lenguajeMY['smsAvisoFG']()}*THE VIDEO SHOULD NOT LAST MORE THAN 7 SECONDS.*`} 
...
//afk-afk.js
const smsAfkQ1 = (usedPrefix, command) => { return `${lenguajeMY['smsAvisoMG']()}*WRITE REASON WHY IT IS INACTIVE (AFK)*\n\n*EXAMPLE:*\n*${usedPrefix + command}* I'm going to do homework`} 
const smsAfkQ2 = () => { return `${lenguajeMY['smsAvisoMG']()}*MINIMUM 10 CHARACTERS MUST BE THE REASON*`} 
const smsAfkM1A = () => { return `*DO NOT TAG*`} 
const smsAfkM1B = () => { return `*WILL BE INACTIVE AFK*\n\n*REASON FOR AFK INACTIVITY:*`} 

//anonymous_chat.js
const smsChatAn1 = () => { return `${lenguajeMY['smsAvisoFG']()}*YOU ARE NOT IN ANONYMOUS CHAT*`} 
...
const smsChatAn4 = () => { return `${lenguajeMY['smsAvisoRG']()}🪐 *YOU LEFT THE ANONYMOUS CHAT*`} 
const smsChatAn5 = () => { return `${lenguajeMY['smsAvisoAG']()}*THE OTHER USER LEFT THE ANONYMOUS CHAT*`}  
const smsChatAn6 = () => { return `*IF YOU WANT TO GO TO ANOTHER ANONYMOUS CHAT USE THE COMMAND #start OR USE THE BUTTON BELOW*\n`} 
const smsChatAn7 = () => { return `${lenguajeMY['smsAvisoAG']()}*YOU ARE STILL IN AN ANONYMOUS CHAT OR WAITING FOR SOMEONE TO JOIN TO CHAT*`} 
...
const smsChatAn10 = () => { return `${lenguajeMY['smsAvisoEG']()}✨ *THEY CAN CHAT NOW*`} 
const smsChatAn11 = () => { return `*SOMEONE JOINED THE ANONYMOUS CHAT!!*`} 
const smsChatAn12 = () => { return `❇️ ANOTHER USER`} 
const smsChatAn13 = () => { return `${lenguajeMY['smsAvisoRG']()}🐈 *WAITING FOR SOMEONE TO JOIN THE ANONYMOUS CHAT, PLEASE BE PATIENT*`} 
...
const smsMalused2 = () => { return `${lenguajeMY['smsAvisoMG']()}🐈 *YOU MUST USE THE COMMAND LIKE THIS EXAMPLE:*\n`}
const smsMalused3 = () => { return `${lenguajeMY['smsAvisoMG']()}🐈 *YOU MUST USE THE COMMAND OR RESPOND TO SOMEONE'S MESSAGE LIKE THIS EXAMPLE:*\n`}
...
//grupo-add.js
const smsAddB1 = () => { return `${lenguajeMY['smsAvisoFG']()}*CANNOT ADD NUMBER, PLEASE VERIFY IT IS CORRECT, MAYBE IT CAME OUT RECENTLY OR YOUR PRIVACY IS SET.*`}
const smsAddB2 = () => { return `${lenguajeMY['smsAvisoFG']()}*CANNOT ADD THE NUMBER, VERIFY IT IS CORRECT, OR ADD IT MANUALLY.*`}
...
const smsAdveu1 = () => { return `${lenguajeMY['smsAvisoAG']()}*CAN ONLY USE IF THE FUNCTION IS ACTIVATED:*\n`}
const smsAdveu2 = () => { return 'Reason'}
const smsAdveu3 = () => { return `${lenguajeMY['smsAvisoMG']()}*REMEMBER TO WRITE THE REASON FOR THE WARNING*\n`}
...
//grupo-kick.js
const smskick1 = () => { return `${lenguajeMY['smsAvisoAG']()}*TAG THE PERSON OR REPLY TO THE MESSAGE OF THE PERSON YOU WANT TO DELETE*\n\n*EXAMPLE: `}
...
//grupo-setbye.js
const smsSetB = () => { return `${lenguajeMY['smsAvisoEG']()}*THE FAREWELL OF THE GROUP HAS BEEN CONFIGURED*`}
const smsSetB2 = () => { return `${lenguajeMY['smsAvisoIIG']()}🙌 *_WRITE THE FAREWELL MESSAGE_*\n*_OPTIONAL YOU CAN USE WHAT IS WITH "@" TO ADD MORE INFORMATION:_*\n\n*⚡ @user (Mention to the user)*\n\n*REMEMBER THAT THE "@" IT'S OPTIONAL*`}

//grupo-setwelcome.js
const smsSetW = () => { return `${lenguajeMY['smsAvisoEG']()}*GROUP WELCOME HAS BEEN SET UP*`}
const smsSetW2 = () => { return `${lenguajeMY['smsAvisoIIG']()}🙌 *_WRITE THE WELCOME MESSAGE_*\n*_OPTIONAL YOU CAN USE WHAT IS WITH "@" TO ADD MORE INFORMATION:_*\n\n*⚡ @user (Mention to the user)*\n*⚡ @subject (Group name)*\n*⚡ @desc (Group description)*\n\n*REMEMBER THAT THE "@" ARE OPTIONAL*`}

//grupo-setdesc.js
const smsDest = () => { return `${lenguajeMY['smsAvisoEG']()}*GROUP DESCRIPTION HAS BEEN CONFIGURED*`}

//grupo-setname.js
const smsNam1 = () => { return `${lenguajeMY['smsAvisoEG']()}*THE GROUP NAME HAS BEEN SET*`}
const smsNam2 = () => { return `${lenguajeMY['smsAvisoMG']()}*🙌 WRITE THE NEW GROUP NAME*`}
const smsNam3 = () => { return `${lenguajeMY['smsAvisoFG']()}*THE NAME OF THE GROUP MUST NOT HAVE MORE THAN 25 CHARACTERS*`}

//grupo-restaurarEnlace.js
const smsRestGp = () => { return `${lenguajeMY['smsAvisoEG']()}*THE GROUP LINK HAS BEEN RESETED*`}
...
//propietario(a.js
const smsPropban1 = (usedPrefix, command, bot) => { return `${lenguajeMY['smsAvisoMG']()}*TAG SOMEONE OR REPLY TO THE USER'S MESSAGE OR WRITE THE NUMBER YOU WANT TO BAN FROM THE COMMANDS*\n\n*EXAMPLE:*\n*${usedPrefix + command} @${bot}*`}
const smsPropban2 = (bot) => { return `${lenguajeMY['smsAvisoFG']()}*@${bot} CANNOT BE BANNED WITH THIS COMMAND* 😹`}
const smsPropban3 = (ownerNumber) => { return `${lenguajeMY.smsAvisoIIG()}😳 *I CAN'T BAN THE OWNER @${ownerNumber} OF ${packname}*`}
const smsPropban4 = (number) => { return `${lenguajeMY.smsAvisoIIG()}*IT IS NOT NECESSARY TO BAN AGAIN @${number} YES IT ALREADY IS* 😊`}
const smsPropban5 = () => { return `${lenguajeMY['smsAvisoEG']()}*USER SUCCESSFULLY BANNED* 🙀`}
const smsPropban6 = (number, usr) => { return `${lenguajeMY.smsAvisoAG()}*@${number} YOU ARE BANNED BY @${user} YOU CANNOT USE THE COMMANDS UNTIL SOMEONE REVERSES THE BAN* 😿`}
const smsPropban7 = (usedPrefix, command, number) => { return `${lenguajeMY['smsAvisoFG']()}*AN ERROR CAME UP, IT MAY BE THAT THE USER IS NOT IN MY DATABASE TRY TO WRITE ${usedPrefix + command} ${number}*\n\`\`\`IF THE ERROR CONTINUES REPORT THIS COMMAND\`\`\``}
...
const smsSoloOwnerJB = () => { return `${lenguajeMY['smsAvisoAG']()}*THIS COMMAND IS DISABLED BY MY OWNER*`}
...
const smsJBConexionClose2 = () => { return `${lenguajeMY['smsAvisoFG']()}🔴 *YOUR DEVICE IS CONNECTED*\n\n*YOU MUST CONNECT AGAIN TO USE:\n#deletesesion`}
const smsreenvia = () => { return `*🟢 RESEND COMMAND...*`}
const smsJBPrincipal = () => { return `${lenguajeMY['smsAvisoAG']()}🔵 *TO BE A SUB BOT GO TO THE MAIN NUMBER*\n*ღ Enter the following link:*\n`}
const smsJBConexion = () => { return `${lenguajeMY['smsAvisoFG']()}🟡 *THE CONNECTION HAS BEEN CLOSED IN AN UNEXPECTED WAY, WE WILL TRY TO RECONNECT...*`}
const smsJBConexionClose = () => { return `${lenguajeMY['smsAvisoFG']()}🔴 *THE CONNECTION HAS BEEN CLOSED, YOU MUST CONNECT MANUALLY USING THE #jadibot COMMAND AND RESCAN THE NEW QR CODE*`}
const smsJBConexionTrue = () => { return `${lenguajeMY['smsAvisoEG']()}🟢 *SUCCESSFUL CONNECTION!!!*`}
const smsJBConexionTrue2 = () => { return `${lenguajeMY['smsAvisoEG']()}🟢 *SUCCESSFUL CONNECTION!!! YOU CAN CONNECT USING:*`}
const smsJBCargando = () => { return `${lenguajeMY['smsAvisoIIG']()}⚪ *IS CONNECTED!! PLEASE WAIT MESSAGES ARE LOADING...*\n\n♻️ *AVAILABLE OPTIONS:*\n*» #stop _(Stop Sub Bot Feature)_*\n*» #deletesesion _(Delete all traces of Sub Bot)_*\n*» #jadibot _(Get new QR code to be Sub Bot)_*`}
...
const smsJBDel = () => { return `${lenguajeMY['smsAvisoAG']()}*USE THIS COMMAND TO THE MAIN BOT*`}
const smsJBAdios = () => { return `${lenguajeMY['smsAvisoEG']()}*I WILL MISS YOU ${global.packname} BYE!! 🥹*`}
const smsJBCerrarS = () => { return `${lenguajeMY['smsAvisoEG']()}*YOU HAVE LOGGED OUT AND DELETED ALL TRACES*`}
const smsJBErr = () => { return `*YOU HAVE LOGGED OUT AS A SUB BOT* ♻️`}

//comandos+18-adult.js
const smsContAdult = () => { return `${lenguajeMY['smsAvisoAG']()}*THE COMMANDS 🔞 THEY ARE DISABLED, IF YOU ARE MY CREATOR USE #on modohorny*`}
...
const smsContacto4 = () => { return 'MylingBot Official Contact 👻'}
