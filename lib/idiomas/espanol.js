...
const eMylingtickers = () => { return '🎫 MylingTickets' } 
...
//_autosticker.js
const smsAutoStik = () => { return `${lenguajeMY['smsAvisoFG']()}*¿POR QUÉ CARAJO DURA MUCHO?. EL VÍDEO NO DEBE DE DURAR MÁS DE 7 SEGUNDOS.*`} 
...
//grupo-kick.js
const smskick1 = () => { return `${lenguajeMY['smsAvisoAG']()}*¿A QUIÉN CARAJO ELIMINO?. ETIQUETE A LA PERSONA O RESPONDA AL MENSAJE DE LA PERSONA QUE QUIERE ELIMINAR*\n\n*EJEMPLO: `}
...
const smsContacto2 = () => { return 'Soy Owner de MylingBot' + packname + ' sí tienes alguna duda me la puedes decir ✌️'}
