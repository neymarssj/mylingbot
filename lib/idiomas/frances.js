...
const smsLista1 = () => { return `🌟 INFORMATIONS MYLINGBOT 🌟`}
...
const smsLista7 = () => { return `🌟 INSTALLER MYLINGBOT 🌟`}
...
//_antilink.js
const smsAdwa = () => { return `${global.lenguajeMY['smsAvisoEG']()}𝘾𝙊𝙈𝙊 𝙀𝙍𝙀𝙎 𝘼𝘿𝙈𝙄𝙉 𝙀𝙉 𝙀𝙇 𝙂𝙍𝙐𝙋𝙊 𝙉𝙊 𝙎𝙀𝙍𝘼𝙎 𝙀𝙇𝙄𝙈𝙄𝙉𝘼𝘿𝙊(𝘼)`}
...
//afk-_afk.js
const smsAfkM1 = () => { return `${lenguajeMY['smsAvisoEG']()}*DEJASTE DE ESTAR INACTIVO AFK*`} 
const smsAfkM2 = () => { return `*EL MOTIVO DE INACTIVIDAD ERA:*`} 
const smsAfkM3 = () => { return `*TIEMPO INACTIVO:*`} 
const smsAfkM4 = () => { return `${lenguajeMY['smsAvisoAG']()}*NO ETIQUETES A ESTE(A) USUARIO(A)!! ESTÁ INACTIVO(A)*`} 
...
//afk-afk.js
const smsAfkM1A = () => { return `${lenguajeMY['smsAvisoAG']()}*NO ETIQUETEN A*`} 
...
//grupo-kick.js
const smskick1 = () => { return `${lenguajeMY['smsAvisoAG']()}*ETIQUETE A LA PERSONA O RESPONDA AL MENSAJE DE LA PERSONA QUE QUIERE ELIMINAR*\n\n*EJEMPLO: `}
...
const smsJBConexionTrue2 = () => { return `${lenguajeMY['smsAvisoEG']()}🟢 *CONEXIÓN CON ÉXITO!!! PUEDE CONECTARSE USANDO:*`}
...
const smsJBAdios = () => { return `${lenguajeMY['smsAvisoEG']()}*TE VOY A EXTRAÑAR ${global.packname} CHAOO!! 🥹*`}
...
const smsContacto4 = () => { return 'Contacto Oficial de MylingBot 👻'}
