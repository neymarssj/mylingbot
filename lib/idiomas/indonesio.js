...
const smsLista1 = () => { return `🌟 INFORMASI MYLINGBOT 🌟`}
...
const smsLista7 = () => { return `🌟 PASANG MYLINGBOT 🌟`}
...
//_allantilink.js
const smsTextoYT = () => { return '𝗠𝗬𝗟𝗜𝗡𝗚𝗕𝗢𝗧-𝗠𝗗 - 𝗪𝗛𝗔𝗧𝗦𝗔𝗣𝗣 👻'}
...
const smsCont7 = () => { return `${global.lenguajeMY['smsAvisoAG']()}*TIDAK MEMILIKI BERLIAN!! 💎 ANDA DAPAT PERGI KE TOKO DENGAN PERINTAH*`}
const smsCont8 = () => { return ` *BERLIAN 💎 DIGUNAKAN*`}
const smsCont9 = () => { return `${global.lenguajeMY['smsAvisoAG']()}*BUTUH TINGKATNYA ➡️*`}
...
//_antilink.js
const smsAdwa = () => { return `${global.lenguajeMY['smsAvisoEG']()}*SEBAGAI ANDA ADMIN DI GRUP INI ANDA TIDAK AKAN DIHAPUS*`}
const smsEnlaceWat = () => { return `${lenguajeMY['smsAvisoAG']()}*LINK WHATSAPP TERBANNED TERDETEKSI DI GRUP INI*\n\n*SAYA LANJUTKAN UNTUK MENGHAPUS ANDA*`}

//_antilink2.js
const smsEnlaceWatt = () => { return `${lenguajeMY['smsAvisoAG']()}LINK TERLARANG MENGANDUNG HTTPS TERDETEKSI DI GRUP INI\n\nSAYA LANJUTKAN UNTUK MENGHAPUS ANDA`}
...
//Kesalahan
const smsMalError = () => { return `${lenguajeMY['smsAvisoFG']()}\`\`\`SEBUAH KESALAHAN YANG TIDAK TERDUGA TELAH TERJADI.\`\`\``}
const smsMalError2 = () => { return `${lenguajeMY['smsAvisoFG']()}\`\`\`KENYAMANAN TELAH TIMBUL. COBA LAGI.\`\`\``}
const smsMalError3 = () => { return `${lenguajeMY['smsAvisoFG']()}\`\`\`ADA YANG SALAH, LAPORAN PERINTAH INI MENGGUNAKAN:\`\`\`\n`}
...
const eMylingtickers = () => { return '🎫 MylingTickers' } 
...
const smsModP2 = () => { return `Aktifkan fungsi agar semua orang dapat menggunakan MylingBot`}
const smsModAd1 = () => { return `🛂 MODE ADMIN`}
const smsModAd2 = () => { return `Hanya Admin yang dapat menggunakan MylingBot di Grup`}
...
//_autosticker.js
const smsAutoStik = () => { return `${lenguajeMY['smsAvisoFG']()}*VIDEO TIDAK HARUS BERAKHIR LEBIH DARI 7 DETIK.*`} 
...
//afk-afk.js
const smsAfkQ1 = (usedPrefix, command) => { return `${lenguajeMY['smsAvisoMG']()}*TULIS ALASAN KENAPA TIDAK AKTIF (AFK)*\n\n*CONTOH:*\n*${usedPrefix + command}* Saya akan mengerjakan pekerjaan rumah`} 
const smsAfkQ2 = () => { return `${lenguajeMY['smsAvisoMG']()}*MINIMUM 10 KARAKTER HARUS MENJADI ALASAN*`} 
const smsAfkM1A = () => { return `*JANGAN TAG*`} 
const smsAfkM1B = () => { return `*AKAN AFK TIDAK AKTIF*\n\n*ALASAN TIDAK AKTIFNYA AFK:*`} 

//anonymous_chat.js
const smsChatAn1 = () => { return `${lenguajeMY['smsAvisoFG']()}*ANDA TIDAK DALAM CHAT ANONIM*`} 
...
const smsChatAn4 = () => { return `${lenguajeMY['smsAvisoRG']()}🪐 *ANDA MENINGGALKAN CHAT ANONIM*`} 
const smsChatAn5 = () => { return `${lenguajeMY['smsAvisoAG']()}*PENGGUNA LAIN MENINGGALKAN CHAT ANONIM*`}  
const smsChatAn6 = () => { return `*JIKA INGIN KE CHAT ANONIM LAIN GUNAKAN PERINTAH #start ATAU GUNAKAN TOMBOL DI BAWAH INI*\n`} 
const smsChatAn7 = () => { return `${lenguajeMY['smsAvisoAG']()}*ANDA MASIH DALAM CHAT ANONIM ATAU MENUNGGU SESEORANG UNTUK BERGABUNG KE CHAT*`} 
...
const smsChatAn10 = () => { return `${lenguajeMY['smsAvisoEG']()}✨ *MEREKA BISA CHAT SEKARANG*`} 
const smsChatAn11 = () => { return `*SESEORANG BERGABUNG DENGAN CHAT ANONIM!!*`} 
const smsChatAn12 = () => { return `❇️ PENGGUNA LAIN`} 
const smsChatAn13 = () => { return `${lenguajeMY['smsAvisoRG']()}🐈 *MENUNGGU SESEORANG UNTUK BERGABUNG DENGAN CHAT ANONIM, HARAP SABAR*`} 
...
const smsMalused2 = () => { return `${lenguajeMY['smsAvisoMG']()}🐈 *ANDA HARUS MENGGUNAKAN PERINTAH SEPERTI CONTOH INI:*\n`}
const smsMalused3 = () => { return `${lenguajeMY['smsAvisoMG']()}🐈 *ANDA HARUS MENGGUNAKAN PERINTAH ATAU MERESPON PESAN SESEORANG SEPERTI CONTOH INI:*\n`}
...
//grupo-add.js
const smsAddB1 = () => { return `${lenguajeMY['smsAvisoFG']()}*TIDAK BISA MENAMBAH NOMOR, HARAP VERIFIKASI BENAR, MUNGKIN BARU KELUAR ATAU PRIVASI ANDA SUDAH DITETAPKAN.*`}
const smsAddB2 = () => { return `${lenguajeMY['smsAvisoFG']()}*TIDAK DAPAT MENAMBAHKAN NOMOR, MEMVERIFIKASI BENAR, ATAU MENAMBAHKANNYA SECARA MANUAL.*`}
...
const smsAdveu1 = () => { return `${lenguajeMY['smsAvisoAG']()}*HANYA DAPAT DIGUNAKAN JIKA FUNGSI DIAKTIFKAN:*\n`}
const smsAdveu2 = () => { return 'Alasan'}
const smsAdveu3 = () => { return `${lenguajeMY['smsAvisoMG']()}*INGAT UNTUK MENULIS ALASAN UNTUK PERINGATAN*\n`}
...
//grupo-kick.js
const smskick1 = () => { return `${lenguajeMY['smsAvisoAG']()}*TAG ORANG ATAU BALAS PESAN ORANG YANG INGIN ANDA HAPUS*\n\n*CONTOH: `}
...
//grupo-setbye.js
const smsSetB = () => { return `${lenguajeMY['smsAvisoEG']()}*PERPISAHAN GRUP TELAH DIKONFIGURASI*`}
const smsSetB2 = () => { return `${lenguajeMY['smsAvisoIIG']()}🙌 *_TULIS PESAN PERPISAHAN_*\n*_OPSIONAL, ANDA DAPAT MENGGUNAKAN APA DENGAN "@" UNTUK MENAMBAHKAN INFORMASI LEBIH LANJUT:_*\n\n*⚡ @user (Sebutkan kepada pengguna)*\n\n*INGAT BAHWA "@" ITU OPSIONAL*`}

//grupo-setwelcome.js
const smsSetW = () => { return `${lenguajeMY['smsAvisoEG']()}*SAMBUTAN GRUP TELAH DIATUR*`}
const smsSetW2 = () => { return `${lenguajeMY['smsAvisoIIG']()}🙌 *_TULIS PESAN SELAMAT DATANG_*\n*_OPSIONAL, ANDA DAPAT MENGGUNAKAN APA DENGAN "@" UNTUK MENAMBAHKAN INFORMASI LEBIH LANJUT:_*\n\n*⚡ @user (Sebutkan kepada pengguna)*\n*⚡ @subject (Nama grup)*\n*⚡ @desc (Deskripsi grup)*\n\n*INGAT BAHWA "@" ADALAH OPSIONAL*`}

//grupo-setdesc.js
const smsDest = () => { return `${lenguajeMY['smsAvisoEG']()}*DESKRIPSI GRUP TELAH DIKONFIGURASI*`}

//grupo-setname.js
const smsNam1 = () => { return `${lenguajeMY['smsAvisoEG']()}*NAMA GRUP TELAH DITETAPKAN*`}
const smsNam2 = () => { return `${lenguajeMY['smsAvisoMG']()}*🙌 TULIS NAMA GRUP BARU*`}
const smsNam3 = () => { return `${lenguajeMY['smsAvisoFG']()}*NAMA GRUP TIDAK BOLEH MEMILIKI LEBIH DARI 25 KARAKTER*`}

//grupo-restaurarEnlace.js
const smsRestGp = () => { return `${lenguajeMY['smsAvisoEG']()}*TAUTAN GROUP TELAH DIRESET*`}
...
//propietario(a).js
const smsJoin = (user) => { return `${packname}\n𝙀𝙎 𝙐𝙉 𝘽𝙊𝙏 𝘿𝙀 𝙒𝙃𝘼𝙏𝙎𝘼𝙋𝙋 𝙌𝙐𝙀 𝙏𝙀 𝘼𝙔𝙐𝘿𝘼𝙍𝘼 𝙍𝙀𝘼𝙇𝙄𝙕𝘼𝙍 𝘿𝙄𝙁𝙀𝙍𝙀𝙉𝙏𝙀𝙎 𝘼𝘾𝙏𝙄𝙑𝙄𝘿𝘼𝘿𝙀𝙎 𝘼𝙇 𝙋𝙍𝙄𝙑𝘼𝘿𝙊 𝙊 𝙂𝙍𝙐𝙋𝙊 𝙔 𝙏𝘼𝙈𝘽𝙄𝙀𝙉 𝙏𝙀 𝙑𝘼𝙎 𝘼 𝘿𝙄𝙑𝙀𝙍𝙏𝙄𝙍 𝘾𝙊𝙉 𝙎𝙐𝙎 𝙈𝙐𝙇𝙏𝙄𝙋𝙇𝙀𝙎 𝙁𝙐𝙉𝘾𝙄𝙊𝙉𝙀𝙎, 𝘿𝙄𝙎𝙁𝙍𝙐𝙏𝘼 𝘿𝙀 𝙈𝙔𝙇𝙄𝙉𝙂𝘽𝙊𝙏!!! 👻\n\n👍 𝙈𝙔𝙇𝙄𝙉𝙂𝘽𝙊𝙏 𝙁𝙐𝙀 𝙄𝙉𝙑𝙄𝙏𝘼𝘿𝙊(𝘼) 𝙋𝙊𝙍:\n@${user}`}
...
//propietario(a.js
const smsPropban1 = (usedPrefix, command, bot) => { return `${lenguajeMY['smsAvisoMG']()}*TAG SESEORANG ATAU BALAS PESAN PENGGUNA ATAU TULIS NOMOR YANG INGIN ANDA BALAS DARI PERINTAH*\n\n*CONTOH:*\n*${usedPrefix + command} @${bot}*`}
const smsPropban2 = (bot) => { return `${lenguajeMY['smsAvisoFG']()}*@${bot} TIDAK DAPAT DILARANG DENGAN PERINTAH INI* 😹`}
const smsPropban3 = (ownerNumber) => { return `${lenguajeMY.smsAvisoIIG()}😳 *SAYA TIDAK BISA MELARKAN PEMILIK @${ownerNumber} DARI ${packname}*`}
const smsPropban4 = (number) => { return `${lenguajeMY.smsAvisoIIG()}*TIDAK PERLU BAN LAGI @${number} YA SUDAH ADA* 😊`}
const smsPropban5 = () => { return `${lenguajeMY['smsAvisoEG']()}*PENGGUNA BERHASIL DILARANG* 🙀`}
const smsPropban6 = (number, usr) => { return `${lenguajeMY.smsAvisoAG()}*@${number} ANDA DILARANG OLEH @${user} ANDA TIDAK DAPAT MENGGUNAKAN PERINTAH HINGGA SESEORANG MEMBALIKKAN BAN* 😿`}
const smsPropban7 = (usedPrefix, command, number) => { return `${lenguajeMY['smsAvisoFG']()}*KESALAHAN MUNCUL, MUNGKIN PENGGUNA TIDAK DALAM DATABASE SAYA MENCOBA MENULIS ${usedPrefix + command} ${number}*\n\`\`\`JIKA KESALAHAN TERUS LANGSUNG LAPORKAN PERINTAH INI\`\`\``}
...
const smsJBConexionClose2 = () => { return `${lenguajeMY['smsAvisoFG']()}🔴 *PERANGKAT ANDA TELAH TERHUBUNG*\n\n*ANDA HARUS TERHUBUNG LAGI UNTUK MENGGUNAKAN:\n#deletesesion`}
const smsreenvia = () => { return `*🟢 KIRIM ULANG PERINTAH...*`}
const smsSoloOwnerJB = () => { return `${lenguajeMY['smsAvisoAG']()}*PERINTAH INI DINONAKTIFKAN OLEH PEMILIK SAYA*`}
const smsJBPrincipal = () => { return `${lenguajeMY['smsAvisoAG']()}🔵 *UNTUK JADI SUB BOT MASUK KE NOMOR UTAMA*\n*ღ Masukkan tautan berikut:*\n`}
const smsJBConexion = () => { return `${lenguajeMY['smsAvisoFG']()}🟡 *KONEKSI TELAH DITUTUP DENGAN CARA YANG TIDAK TERDUGA, KAMI AKAN MENCOBA MENGHUBUNGKAN KEMBALI...*`}
const smsJBConexionClose = () => { return `${lenguajeMY['smsAvisoFG']()}🔴 *KONEKSI TELAH DITUTUP, ANDA HARUS MENGHUBUNGKAN SECARA MANUAL MENGGUNAKAN #jadibot PERINTAH DAN PINDAI ULANG KODE QR BARU*`}
const smsJBConexionTrue = () => { return `${lenguajeMY['smsAvisoEG']()}🟢 *KONEKSI SUKSES!!!*`}
const smsJBConexionTrue2 = () => { return `${lenguajeMY['smsAvisoEG']()}🟢 *KONEKSI SUKSES!!! ANDA DAPAT MENGHUBUNGKAN MENGGUNAKAN:*`}
const smsJBCargando = () => { return `${lenguajeMY['smsAvisoIIG']()}⚪ *TERHUBUNG!! SILAKAN TUNGGU PESAN sedang DIMUAT...*\n\n♻️ *PILIHAN YANG TERSEDIA:*\n*» #stop _(Hentikan Fitur Sub Bot)_*\n*» #deletesesion _(Hapus semua jejak Sub Bot)_*\n*» #jadibot _(Dapatkan kode QR baru untuk menjadi Sub Bot)_*`}
...
const smsJBDel = () => { return `${lenguajeMY['smsAvisoAG']()}*GUNAKAN PERINTAH INI KE BOT UTAMA*`}
const smsJBAdios = () => { return `${lenguajeMY['smsAvisoEG']()}*AKU AKAN MERINDUKANMU ${global.packname} SELAMAT TINGGAL!! 🥹*`}
const smsJBCerrarS = () => { return `${lenguajeMY['smsAvisoEG']()}*ANDA TELAH KELUAR DAN MENGHAPUS SEMUA JEJAK*`}
const smsJBErr = () => { return `*ANDA TELAH LOG OUT SEBAGAI SUB BOT* ♻️`}

//comandos+18-adult.js
const smsContAdult = () => { return `${lenguajeMY['smsAvisoAG']()}*PERINTAH 🔞 MEREKA CACAT, JIKA ANDA ADALAH CREATOR SAYA GUNAKAN #on modohorny*`}
...
const smsContacto4 = () => { return 'Kontak Resmi MylingBot 👻'}
