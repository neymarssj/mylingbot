...
const smsRowner = () => { return `\`\`\`¡¡ESSE COMANDO SÓ EU COMO CRIADOR DEL BOT PODE USAR!!\`\`\`` }
...
const smsLista1 = () => { return `🌟 INFORMAÇÕES DO MYLINGBOT 🌟`}
...
const smsCont7 = () => { return `${global.lenguajeMY['smsAvisoAG']()}*NÃO TEM DIAMANTES!! 💎 VOCÊ PODE IR À LOJA COM O COMANDO*`}
const smsCont8 = () => { return ` *DIAMANTE 💎 USADO*`}
const smsCont9 = () => { return `${global.lenguajeMY['smsAvisoAG']()}*PRECISO DO NÍVEL ➡️*`}
...
//_antilink.js
const smsAdwa = () => { return `${global.lenguajeMY['smsAvisoEG']()}*COMO VOCÊ É ADMINISTRADOR NESTE GRUPO, VOCÊ NÃO SERÁ REMOVIDO*`}
const smsEnlaceWat = () => { return `${lenguajeMY['smsAvisoAG']()}*UM LINK DE WHATSAPP BANIDO FOI DETECTADO NESTE GRUPO*\n\n*EU CONTINUO A TE EXCLUIR*`}

//_antilink2.js
const smsEnlaceWatt = () => { return `${lenguajeMY['smsAvisoAG']()}UM LINK PROIBIDO CONTENDO HTTPS FOI DETECTADO NESTE GRUPO\n\nEU CONTINUO A TE EXCLUIR`}
...
//Erro
const smsMalError = () => { return `${lenguajeMY['smsAvisoFG']()}\`\`\`OCORREU UM ERRO INESPERADO.\`\`\``}
const smsMalError2 = () => { return `${lenguajeMY['smsAvisoFG']()}\`\`\`SURGIU UMA INCONVENIÊNCIA. TENTE NOVAMENTE.\`\`\``}
const smsMalError3 = () => { return `${lenguajeMY['smsAvisoFG']()}\`\`\`ALGO DEU ERRADO, DENUNCIE ESTE COMANDO USANDO:\`\`\`\n`}
...
const smsModP2 = () => { return `Ativar função para que todos possam usar o MylingBot`}
const smsModAd1 = () => { return `🛂 MODO ADMINISTRADOR`}
const smsModAd2 = () => { return `Apenas Admins poderão usar o MylingBot em Grupos`}
...
//_autosticker.js
const smsAutoStik = () => { return `${lenguajeMY['smsAvisoFG']()}*O VÍDEO NÃO DEVE DURAR MAIS DE 7 SEGUNDOS.*`} 
...
//afk-afk.js
const smsAfkQ1 = (usedPrefix, command) => { return `${lenguajeMY['smsAvisoMG']()}*ESCREVA A RAZÃO PELA QUAL ESTÁ INATIVO (AFK)*\n\n*EXEMPLO:*\n*${usedPrefix + command}* vou fazer lição de casa`} 
const smsAfkQ2 = () => { return `${lenguajeMY['smsAvisoMG']()}*MÍNIMO DE 10 CARACTERES DEVEM SER A RAZÃO*`} 
const smsAfkM1A = () => { return `*NÃO ETIQUETE A*`} 
const smsAfkM1B = () => { return `*VAI ESTAR INATIVO AFK*\n\n*MOTIVO PARA INATIVIDADE AFK:*`} 

//anonymous_chat.js
const smsChatAn1 = () => { return `${lenguajeMY['smsAvisoFG']()}*VOCÊ NÃO ESTÁ NO CHAT ANÔNIMO*`} 
...
const smsChatAn4 = () => { return `${lenguajeMY['smsAvisoRG']()}🪐 *VOCÊ SAIU DO CHAT ANÔNIMO*`} 
const smsChatAn5 = () => { return `${lenguajeMY['smsAvisoAG']()}*O OUTRO USUÁRIO SAIU DO CHAT ANÔNIMO*`}  
const smsChatAn6 = () => { return `*SE QUISER IR PARA OUTRO CHAT ANÔNIMO USE O COMANDO #start OU ACESSE O BOTÃO ABAIXO*\n`} 
const smsChatAn7 = () => { return `${lenguajeMY['smsAvisoAG']()}*VOCÊ AINDA ESTÁ EM UM CHAT ANÔNIMO OU ESPERANDO QUE ALGUÉM ENTRE NO CHAT*`} 
...
const smsChatAn10 = () => { return `${lenguajeMY['smsAvisoEG']()}✨ *ELES PODEM CONVERSAR AGORA*`} 
const smsChatAn11 = () => { return `*ALGUÉM ENTROU NO CHAT ANÔNIMO!!*`} 
const smsChatAn12 = () => { return `❇️ OUTRO USUÁRIO`} 
const smsChatAn13 = () => { return `${lenguajeMY['smsAvisoRG']()}🐈 *ESPERANDO ALGUÉM ENTRAR NO CHAT ANÔNIMO, SEJA PACIENTE*`} 
...
const smsMalused2 = () => { return `${lenguajeMY['smsAvisoMG']()}🐈 *VOCÊ DEVE USAR O COMANDO COMO ESTE EXEMPLO:*\n`}
const smsMalused3 = () => { return `${lenguajeMY['smsAvisoMG']()}🐈 *VOCÊ DEVE USAR O COMANDO OU RESPONDER À MENSAGEM DE ALGUÉM COMO ESTE EXEMPLO:*\n`}
...
//grupo-add.js
const smsAddB1 = () => { return `${lenguajeMY['smsAvisoFG']()}*NÃO É POSSÍVEL ADICIONAR NÚMERO, POR FAVOR VERIFIQUE SE ESTÁ CORRETO, TALVEZ SEJA RECENTEMENTE OU SUA PRIVACIDADE ESTÁ DEFINIDA.*`}
const smsAddB2 = () => { return `${lenguajeMY['smsAvisoFG']()}*NÃO É POSSÍVEL ADICIONAR O NÚMERO, VERIFICAR SE ESTÁ CORRETO OU ADICIONAR MANUALMENTE.*`}
...
const smsAdveu1 = () => { return `${lenguajeMY['smsAvisoAG']()}*SÓ PODE USAR SE A FUNÇÃO ESTIVER ATIVADA:*\n`}
const smsAdveu2 = () => { return 'Razão'}
const smsAdveu3 = () => { return `${lenguajeMY['smsAvisoMG']()}*LEMBRE-SE DE ESCREVER O MOTIVO DO AVISO*\n`}
...
//grupo-kick.js
const smskick1 = () => { return `${lenguajeMY['smsAvisoAG']()}*MARQUE A PESSOA OU RESPONDA A MENSAGEM DA PESSOA QUE DESEJA EXCLUIR*\n\n*EXEMPLO: `}
...
//grupo-setbye.js
const smsSetB = () => { return `${lenguajeMY['smsAvisoEG']()}*A DESPEDIDA DO GRUPO ESTÁ CONFIGURADA*`}
const smsSetB2 = () => { return `${lenguajeMY['smsAvisoIIG']()}🙌 *_ESCREVA A MENSAGEM DE ADEUS_*\n*_OPCIONAL VOCÊ PODE USAR WHAT IS COM "@" PARA ADICIONAR MAIS INFORMAÇÕES:_*\n\n*⚡ @user (Menção ao usuário)*\n\n*LEMBRE-SE QUE O "@" É OPCIONAL*`}

//grupo-setwelcome.js
const smsSetW = () => { return `${lenguajeMY['smsAvisoEG']()}*AS BOAS-VINDAS DO GRUPO FOI CONFIGURADA*`}
const smsSetW2 = () => { return `${lenguajeMY['smsAvisoIIG']()}🙌 *_ESCREVA A MENSAGEM DE BEM-VINDO_*\n*_OPCIONAL VOCÊ PODE USAR WHAT IS COM "@" PARA ADICIONAR MAIS INFORMAÇÕES:_*\n\n*⚡ @user (Menção ao usuário)*\n*⚡ @subject (Nome do grupo)*\n*⚡ @desc (Descrição do grupo)*\n\n*LEMBRE-SE QUE OS "@" SÃO OPCIONAIS*`}

//grupo-setdesc.js
const smsDest = () => { return `${lenguajeMY['smsAvisoEG']()}*A DESCRIÇÃO DO GRUPO FOI CONFIGURADA*`}

//grupo-setname.js
const smsNam1 = () => { return `${lenguajeMY['smsAvisoEG']()}*O NOME DO GRUPO FOI DEFINIDO*`}
const smsNam2 = () => { return `${lenguajeMY['smsAvisoMG']()}*🙌 ESCREVA O NOME DO NOVO GRUPO*`}
const smsNam3 = () => { return `${lenguajeMY['smsAvisoFG']()}*O NOME DO GRUPO NÃO DEVE TER MAIS DE 25 CARACTERES*`}

//grupo-restaurarEnlace.js
const smsRestGp = () => { return `${lenguajeMY['smsAvisoEG']()}*O LINK DO GRUPO FOI REINICIALIZADO*`}
...
const smsPropban5 = () => { return `${lenguajeMY['smsAvisoEG']()}*USUARIO BANEADO CON ÉXITO* 🙀`}
...
const smsJBConexionClose2 = () => { return `${lenguajeMY['smsAvisoFG']()}🔴 *SEU DISPOSITIVO ESTÁ CONECTADO*\n\n*VOCÊ DEVE CONECTAR NOVAMENTE PARA USAR:\n#deletesesion`}
const smsreenvia = () => { return `*🟢 COMANDO DE REENVIAR...*`}
const smsSoloOwnerJB = () => { return `${lenguajeMY['smsAvisoAG']()}*ESTE COMANDO ESTÁ DESATIVADO PELO MEU PROPRIETÁRIO*`}
const smsJBPrincipal = () => { return `${lenguajeMY['smsAvisoAG']()}🔵 *PARA SER UM SUB BOT VAI AO NÚMERO PRINCIPAL*\n*ღ Entre no seguinte link:*\n`}
const smsJBConexion = () => { return `${lenguajeMY['smsAvisoFG']()}🟡 *A CONEXÃO FOI FECHADA DE FORMA INESPERADA, TENTAREMOS RECONECTAR...*`}
const smsJBConexionClose = () => { return `${lenguajeMY['smsAvisoFG']()}🔴 *A CONEXÃO FOI FECHADA, VOCÊ DEVE CONECTAR MANUALMENTE ATRAVÉS DO #jadibot COMANDO E ESCANEAR O NOVO CÓDIGO QR*`}
const smsJBConexionTrue = () => { return `${lenguajeMY['smsAvisoEG']()}🟢 *CONEXÃO COM SUCESSO!!!*`}
const smsJBConexionTrue2 = () => { return `${lenguajeMY['smsAvisoEG']()}🟢 *CONEXÃO COM SUCESSO!!! VOCÊ PODE SE CONECTAR USANDO:*`}
const smsJBCargando = () => { return `${lenguajeMY['smsAvisoIIG']()}⚪ *ESTÁ CONECTADO!! AGUARDE AS MENSAGENS ESTÃO CARREGANDO...*\n\n♻️ *OPÇÕES DISPONÍVEIS:*\n*» #stop _(Recurso Parar Subbot)_*\n*» #deletesesion _(Exclua todos os vestígios de Sub Bot)_*\n*» #jadibot _(Obtenha um novo código QR para ser Sub Bot)_*`}
...
const smsJBDel = () => { return `${lenguajeMY['smsAvisoAG']()}*USE ESTE COMANDO PARA O BOT PRINCIPAL*`}
const smsJBAdios = () => { return `${lenguajeMY['smsAvisoEG']()}*VOU SENTIR SAUDADES ${global.packname} TCHAU!! 🥹*`}
const smsJBCerrarS = () => { return `${lenguajeMY['smsAvisoEG']()}*VOCÊ SAIU E EXCLUIU TODOS OS RASTREIOS*`}
const smsJBErr = () => { return `*YOU HAVE LOGGED OUT AS A SUB BOT* ♻️`}

//comandos+18-adult.js
const smsContAdult = () => { return `${lenguajeMY['smsAvisoAG']()}*OS COMANDOS 🔞 ELES ESTÃO DESATIVADOS, SE VOCÊ FOR MEU CRIADOR, USE #on modohorny*`}
...
const smsContacto4 = () => { return 'Contato Oficial MylingBot 👻'}
